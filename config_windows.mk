...
# @TESTDBS@/@TESTAPIS@ filled in by configure.vbs (see #8091).  testall.vbs is
# generated by configure.vbs too - the make replace chain can't pass prefix's
# space or TESTDBS/TESTAPIS's quotes/commas through the command line - so
# TESTSCRIPTS is empty here and make doesn't regenerate it (see #8484).
TESTDBS = @TESTDBS@
TESTAPIS = @TESTAPIS@
TESTSCRIPTS =
