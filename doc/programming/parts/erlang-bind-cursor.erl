...
sqlrelay:prepareQuery("begin  :curs:=sp_mytable; end;"),
sqlrelay:defineOutputBindCursor("curs"),
sqlrelay:executeQuery(),

BindCur = sqlrelay:getOutputBindCursor("curs"),
sqlrelay:fetchFromBindCursor(),
