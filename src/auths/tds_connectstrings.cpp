...
class SQLRSERVER_DLLSPEC sqlrauth_tds_connectstrings : public sqlrauth {
	public:
		sqlrauth_tds_connectstrings(sqlrservercontroller *cont,
							domnode *parameters);
		~sqlrauth_tds_connectstrings();
...
sqlrauth_tds_connectstrings::sqlrauth_tds_connectstrings(
...
const char *sqlrauth_tds_connectstrings::auth(sqlrcredentials *cred) {
...
const char *sqlrauth_tds_connectstrings::userPassword(
						const char *user,
						const char *password,
						uint64_t index) {
...
extern "C" {
	SQLRSERVER_DLLSPEC sqlrauth *new_sqlrauth_tds_connectstrings(
						sqlrservercontroller *cont,
						domnode *parameters) {
		return new sqlrauth_tds_connectstrings(cont,parameters);
	}
}
