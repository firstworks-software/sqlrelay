...
const char *informixconnection::getColumnListQuery(
	...
	return (wild)?
		"select "
		"	st.owner as table_cat, "
		"	'' as table_schem, "
		"	st.tabname as table_name, "
		"	sc.colname as column_name, "
		"	sc.coltype as data_type, "
		"	decode(mod(sc.coltype,256), "
		"		41, "
		"		decode(sc.extended_id, "
		"			10,'clob', "
		"			11,'blob', "
		"			'boolean'), "
		"		1,'smallint', "
		...
		"	decode(mod(sc.coltype,256), "
		"		5,floor(sc.collength/256), "
		"		8,floor(sc.collength/256), "
		"		10,8, "
		"		12,2147483648, "
		"		11,2147483648, "
		"		sc.collength) as column_size, "
		"	decode(mod(sc.coltype,256), "
		"		5,floor(sc.collength/256), "
		"		8,floor(sc.collength/256), "
		"		10,8, "
		"		12,2147483648, "
		"		11,2147483648, "
		"		sc.collength) as buffer_length, "
		"	decode(mod(sc.coltype,256), "
		"		5,mod(sc.collength,256), "
		"		8,mod(sc.collength,256), "
		"		0) as decimal_digits, "
		"	10 as num_prec_radix, "
		"	case "
		"		when (sc.coltype<256) then 1 "
		"		else 0 "
		"	end as nullable, "
		"	case "
		"		when mod(sc.coltype,256) in (6,18) "
		"			then 'auto_increment ' "
		"		else '' "
		"	end as remarks, "
		"	decode(mod(sc.coltype,256), "
		...
		"		12,2147483648, "
		"		11,2147483648, "
		"		sc.collength) as char_octet_length, "
		"	sc.colno as ordinal_position, "
		"	case "
		"		when (sc.coltype<256) then 'YES' "
		"		else 'NO' "
		"	end as is_nullable, "
		"	decode(mod(sc.coltype,256), "
		"		5,floor(sc.collength/256), "
		...
		"	systables st, "
		"	syscolumns sc "
		"	left outer join sysdefaults sd on "
		"		sd.tabid=sc.tabid "
		"		and "
		"		sd.colno=sc.colno "
		"	left outer join ( "
		...
		"			sysconstraints scon "
		"		where "
		"			si.idxname = ip.idxname "
		"			and "
		"			si.tabid = ip.tabid "
		"			and "
		"			scon.idxname = si.idxname "
		"			and "
		"			scon.tabid = si.tabid "
		"			and "
		"			scon.constrtype in ('P', 'U', 'R') "
		"		group by "
		"			ip.tabid, "
		"			ip.colno "
		"	) ck "
		"		on sc.tabid = ck.tabid "
		"		and sc.colno = ck.colno "
		"where "
		"	upper(st.tabname)=upper('%s') "
		"	and "
		"	sc.tabid=st.tabid "
		"	and "
		"	sc.colname like '%s' "
