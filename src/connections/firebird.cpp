...
const char *firebirdconnection::getColumnListQuery(
	...
	return (wild)?
		...
		"	end as nullable, "
		"	case "
		"		when r.rdb$identity_type is not null "
		"			then 'auto_increment ' || "
		"				coalesce(r.rdb$description,'') "
		"		else coalesce(r.rdb$description,'') "
		"	end as remarks, "
		...
		"	where "
		"		rc.rdb$index_name=ise.rdb$index_name "
		"		and "
		...
		") ck "
		"on "
		"	r.rdb$relation_name=ck.rdb$relation_name "
		"	and "
		"	r.rdb$field_name=ck.rdb$field_name "
		"where "
