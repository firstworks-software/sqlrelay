...
static void helpmessage(const char *progname) {
	stdoutput.printf(
		...
		"\n"
		"Command options:\n"
		"	-file filename		Import the specified file.  The name of the\n"
		"				table or sequence to import into comes from\n"
		"				the file itself, if the file provides one, and\n"
		"				is otherwise derived from the file name, with\n"
		"				the .xml or .csv extension removed if the file\n"
		"				name has it.  A file name that leaves nothing\n"
		"				behind, like .xml, is an error.\n"
		"\n"
