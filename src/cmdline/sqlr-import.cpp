...
static void helpmessage(const char *progname) {
	stdoutput.printf(
		...
		"\n"
		"Command options:\n"
		"	-file filename		Import the specified file.  If -table is not\n"
		"				given, the name of the table or sequence to\n"
		"				import into comes from the file itself, if the\n"
		"				file provides one, and is otherwise derived\n"
		"				from the file name, with the .xml or .csv\n"
		"				extension removed if the file name has it.  A\n"
		"				file name that leaves nothing behind, like\n"
		"				.xml, is then an error.\n"
		"\n"
		"	-table name		Import into the specified table or sequence,\n"
		"				rather than the one the file names.  This\n"
		"				option wins over the name recorded in the\n"
		"				file and over the name derived from the file\n"
		"				name.\n"
		"\n"
