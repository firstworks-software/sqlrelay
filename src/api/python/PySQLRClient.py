...
class sqlrconnection:
    ...
    def setBackslashEscapesQuotes(self, backslashescapesquotes):
        """
        ...
        """
        return CSQLRelay.setBackslashEscapesQuotes(self.connection, backslashescapesquotes)
    ...
    def enableKerberos(self, service, mech, flags):
        ...
        empty or None then a default set of flags will be used.
...
class sqlrcursor:
    ...
    def setCursorName(self, cursorname):
        ...
        """
        return CSQLRelay.setCursorName(self.cursor,cursorname)

    def getCursorName(self):
        """
        Returns the name most recently passed to
        setCursorName(), or None if setCursorName() was
        ...
        using, as not all databases support named cursors.

        Not all databases support this call.  Don't use
        it for applications which are designed to be
        portable across databases.
        """
        return CSQLRelay.getCursorName(self.cursor)
