...
JNIEXPORT jint JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getConnectTimeoutSeconds
  (JNIEnv *env, jobject self) {
	return (jint)getSqlrConnection(env,self)->getConnectTimeoutSeconds();
}
...
JNIEXPORT jint JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getConnectTimeoutMicroseconds
  (JNIEnv *env, jobject self) {
	return (jint)getSqlrConnection(env,self)->getConnectTimeoutMicroseconds();
}
...
JNIEXPORT jint JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getResponseTimeoutSeconds
  (JNIEnv *env, jobject self) {
	return (jint)getSqlrConnection(env,self)->getResponseTimeoutSeconds();
}
...
JNIEXPORT jint JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getResponseTimeoutMicroseconds
  (JNIEnv *env, jobject self) {
	return (jint)getSqlrConnection(env,self)->getResponseTimeoutMicroseconds();
}
...
/*
 * Class:     com_firstworks_sqlrelay_SQLRConnection
 * Method:    setQuoteEscapes
 * Signature: (Ljava/lang/String;)V
 */
JNIEXPORT void setQuoteEscapes
  (JNIEnv *env, jobject self, jstring escapechars) {

	char	*escapecharsstring=conGetStringUTFChars(env,escapechars,0);

	getSqlrConnection(env,self)->
		setQuoteEscapes(escapecharsstring);

	conReleaseStringUTFChars(env,escapechars,escapecharsstring);
}
...
JNIEXPORT jstring JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getCurrentUser
  (JNIEnv *env, jobject self) {
	return conNewStringUTF(env,getSqlrConnection(env,self)->getCurrentUser());
}
...
JNIEXPORT jstring JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getDefaultIsolationLevel__
  (JNIEnv *env, jobject self) {
	return conNewStringUTF(env,getSqlrConnection(env,self)->getDefaultIsolationLevel());
}
...
JNIEXPORT jstring JNICALL Java_com_firstworks_sqlrelay_SQLRConnection_getDefaultIsolationLevel__I
  (JNIEnv *env, jobject self, jint format) {
	return conNewStringUTF(env,getSqlrConnection(env,self)->
		getDefaultIsolationLevel((sqlrclientisolationlevelformat_t)format));
}
