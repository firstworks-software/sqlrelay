...
int main(int argc, char **argv) {
	...
	assertTrue(cur->sendQuery("insert into testtable values (1,'testchar1','testvarchar1','01-JAN-2001','testlong1')"));
	...
	assertTrue(cur->sendQuery("insert into testtable values (10,'testchar10','testvarchar10','01-JAN-2010','testlong10')"));
	assertTrue(secondcur->sendQuery("select count(*) from testtable"));
