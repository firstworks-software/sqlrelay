...
assertEqInt(cur.getColumnLength(4),44);
assertEqInt(cur.getColumnLength("testchar"),44);
assertEqInt(cur.getColumnLength(5),44);
assertEqInt(cur.getColumnLength("testvarchar"),44);
