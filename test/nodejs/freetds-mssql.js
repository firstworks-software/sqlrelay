...
// instantiation
var	con=new sqlrelay.SQLRConnection("sqlrelay",9032,"/tmp/freetds-mssql.socket",
...
assertEqInt(cur.getColumnLength(14),16);
assertEqInt(cur.getColumnLength("testdate"),16);
assertEqInt(cur.getColumnLength(15),16);
assertEqInt(cur.getColumnLength("testtime"),16);
assertEqInt(cur.getColumnLength(16),16);
assertEqInt(cur.getColumnLength("testdatetime2"),16);
console.log();
...
assertEqInt(cur.getLongest("testdatetime2"),26);
console.log();
...
assertEqStr(cur.getField(0,"testdatetime2"),"Jan  1 2001 01:01:01:000PM");
console.log();
...
assertEqStr(cur.getField(7,"testdatetime2"),"Jan  1 2001 01:01:01:000PM");
console.log();
...
assertEqInt(cur.getFieldLength(0,"testdatetime2"),26);
console.log();
...
assertEqInt(cur.getFieldLength(7,"testdatetime2"),26);
console.log();
...
cur.cacheToFile("cachefile1-freetds-mssql");
cur.setCacheTtl(200);
assertTrue(cur.sendQuery("select * from testtable "+
	"order by testint"));
...
cur.cacheToFile("cachefile2-freetds-mssql");
assertTrue(cur.openCachedResultSet("cachefile1-freetds-mssql"));
cur.cacheOff();
assertTrue(cur.openCachedResultSet("cachefile2-freetds-mssql"));
assertEqStr(cur.getField(7,0),"8");
assertEqStr(cur.getField(8,0),null);
console.log();
...
var	secondcon=new sqlrelay.SQLRConnection("sqlrelay",9032,"/tmp/freetds-mssql.socket",
	"testuser","testpassword",0,1);
