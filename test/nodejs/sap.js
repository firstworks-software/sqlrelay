...
assertEqInt(cur.getLongest(3),18);
assertEqInt(cur.getLongest("testreal"),18);
assertEqInt(cur.getLongest(4),18);
assertEqInt(cur.getLongest("testfloat"),18);
...
//assertEqStr(cur.getField(0,3),"1.1");
...
//assertEqStr(cur.getField(7,3),"8.8");
//assertEqStr(cur.getField(7,4),"8.8");
assertEqStr(cur.getField(7,5),"8.8");
assertEqStr(cur.getField(7,6),"8.8");
...
assertEqInt(cur.getFieldLength(0,3),18);
assertEqInt(cur.getFieldLength(0,4),18);
...
assertEqInt(cur.getFieldLength(7,3),18);
assertEqInt(cur.getFieldLength(7,4),18);
...
assertEqStr(cur.getField(0,"testnumeric"),"1.1");
...
assertEqStr(cur.getField(7,"testdecimal"),"8.8");
assertEqStr(cur.getField(7,"testnumeric"),"8.8");
...
assertTrue(kn!==null && kn.length>0);
assertTrue(cur.sendQuery("drop table testtable"));
console.log();
