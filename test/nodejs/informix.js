...
assertEqStr(cur.getField(0,5),"1.10");
assertEqStr(cur.getField(0,6),"1.10");
assertEqStr(cur.getField(0,7),"1.1");
assertEqStr(cur.getField(0,8),"1.1");
...
assertEqStr(cur.getField(7,5),"8.80");
assertEqStr(cur.getField(7,6),"8.80");
assertEqStr(cur.getField(7,7),"8.8");
assertEqStr(cur.getField(7,8),"8.8");
...
assertEqStr(cur.getField(0,"testmoney"),"1.10");
assertEqStr(cur.getField(0,"testsmallfloat"),"1.1");
...
assertEqStr(cur.getField(7,"testmoney"),"8.80");
assertEqStr(cur.getField(7,"testsmallfloat"),"8.8");
