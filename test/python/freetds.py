...
def main():
	...
	#assertEqual(fields[7],Decimal("1.0"))
	#assertEqual(fields[8],Decimal("1.0"))
	...
	#assertEqual(fields["testmoney"],Decimal("1.0"))
	#assertEqual(fields["testsmallmoney"],Decimal("1.0"))
	...
	#assertEqual(fields["testmoney"],Decimal("8.0"))
	#assertEqual(fields["testsmallmoney"],Decimal("8.0"))
	...
	#assertEqual(rows[0][9],"Jan  1 2001 01:00:00:000AM")
	#assertEqual(rows[0][10],"Jan  1 2001 01:00:00:000AM")
	...
	#assertEqual(rows[1][9],"Jan  1 2002 02:00:00:000AM")
	#assertEqual(rows[1][10],"Jan  1 2002 02:00:00:000AM")
	...
	#assertEqual(rows[2][9],"Jan  1 2003 03:00:00:000AM")
	#assertEqual(rows[2][10],"Jan  1 2003 03:00:00:000AM")
	...
	#assertEqual(rows[3][9],"Jan  1 2004 04:00:00:000AM")
	#assertEqual(rows[3][10],"Jan  1 2004 04:00:00:000AM")
	...
	#assertEqual(rows[4][9],"Jan  1 2005 05:00:00:000AM")
	#assertEqual(rows[4][10],"Jan  1 2005 05:00:00:000AM")
	...
	#assertEqual(rows[5][9],"Jan  1 2006 06:00:00:000AM")
	#assertEqual(rows[5][10],"Jan  1 2006 06:00:00:000AM")
