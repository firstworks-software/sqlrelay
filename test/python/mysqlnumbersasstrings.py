...
def main():
	...
	assertEqual(cur.getColumnType(14),"CHAR")
	...
	assertEqual(rows[0][5],"1.1")
	assertEqual(rows[0][6],"1.1")
	assertEqual(rows[0][7],"1.1")
	...
	assertEqual(rows[0][13],"text1")
	assertEqual(rows[0][14],"varchar1")
	assertEqual(rows[0][15],"tinytext1")
	assertEqual(rows[0][16],"mediumtext1")
	assertEqual(rows[0][17],"longtext1")
	print()
	...
	assertEqual(rows[1][5],"2.1")
	assertEqual(rows[1][6],"2.1")
	assertEqual(rows[1][7],"2.1")
	...
	assertEqual(rows[1][13],"text2")
	assertEqual(rows[1][14],"varchar2")
	assertEqual(rows[1][15],"tinytext2")
	assertEqual(rows[1][16],"mediumtext2")
	assertEqual(rows[1][17],"longtext2")
	print()
	...
	assertEqual(rows[2][5],"3.1")
	assertEqual(rows[2][6],"3.1")
	assertEqual(rows[2][7],"3.1")
	...
	assertEqual(rows[2][13],"text3")
	assertEqual(rows[2][14],"varchar3")
	assertEqual(rows[2][15],"tinytext3")
	assertEqual(rows[2][16],"mediumtext3")
	assertEqual(rows[2][17],"longtext3")
	print()
	...
	assertEqual(rows[3][5],"4.1")
	assertEqual(rows[3][6],"4.1")
	assertEqual(rows[3][7],"4.1")
	...
	assertEqual(rows[3][13],"text4")
	assertEqual(rows[3][14],"varchar4")
	assertEqual(rows[3][15],"tinytext4")
	assertEqual(rows[3][16],"mediumtext4")
	assertEqual(rows[3][17],"longtext4")
	print()
	...
	assertEqual(rows[4][5],"5.1")
	assertEqual(rows[4][6],"5.1")
	assertEqual(rows[4][7],"5.1")
	...
	assertEqual(rows[4][13],"text5")
	assertEqual(rows[4][14],"varchar5")
	assertEqual(rows[4][15],"tinytext5")
	assertEqual(rows[4][16],"mediumtext5")
	assertEqual(rows[4][17],"longtext5")
	print()
	...
	assertEqual(rows[5][5],"6.1")
	assertEqual(rows[5][6],"6.1")
	assertEqual(rows[5][7],"6.1")
	...
	assertEqual(rows[5][13],"text6")
	assertEqual(rows[5][14],"varchar6")
	assertEqual(rows[5][15],"tinytext6")
	assertEqual(rows[5][16],"mediumtext6")
	assertEqual(rows[5][17],"longtext6")
	print()
