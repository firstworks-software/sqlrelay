...
def main():
	...
	# instantiation
	con=PySQLRClient.sqlrconnection("sqlrelay",9032,"/tmp/freetds-mssql.socket",
	...
	secondcon=PySQLRClient.sqlrconnection("sqlrelay",9032,"/tmp/freetds-mssql.socket",
						"testuser","testpassword",0,1)
	...
	# current behavior, so it is the assertion that has to change when
	# #9389 is fixed.
	assertEquals(cur.getField(0,0),"\0"*32768)
