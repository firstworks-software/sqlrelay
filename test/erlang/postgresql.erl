...
main() ->
    ...
    assertEqualsInt(sqlrelay:getColumnLengthByIndex(4), 44),
    assertEqualsInt(sqlrelay:getColumnLengthByName("testchar"), 44),
    assertEqualsInt(sqlrelay:getColumnLengthByIndex(5), 44),
    assertEqualsInt(sqlrelay:getColumnLengthByName("testvarchar"), 44),
