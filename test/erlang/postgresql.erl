...
main() ->
    ...
    sqlrelay:cacheToFile("cachefile1-postgresql"),
    sqlrelay:setCacheTtl(200),
    assertTrue(sqlrelay:sendQuery("select * from testtable order by testint")),
    {ok, Filename1} = sqlrelay:getCacheFileName(),
    assertEqualsString(Filename1, "cachefile1-postgresql"),
    sqlrelay:cacheOff(),
    ...
    assertEqualsString(Filename2, "cachefile1-postgresql"),
    sqlrelay:cacheOff(),
    ...
    sqlrelay:cacheToFile("cachefile2-postgresql"),
    assertTrue(sqlrelay:openCachedResultSet("cachefile1-postgresql")),
    sqlrelay:cacheOff(),
    assertTrue(sqlrelay:openCachedResultSet("cachefile2-postgresql")),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 0), "8"),
    assertEqualsString(sqlrelay:getFieldByIndex(8, 0), null),
    io:format("~n"),
    ...
    assertEqualsString(Filename3, "cachefile1-postgresql"),
    ...
    assertEqualsString(sqlrelay:getColumnName(0), "Database"),
    assertInResultSet("Database", "public"),
    io:format("~n"),
    ...
    assertEqualsString(sqlrelay:errorSqlState(), "42P07"),
    assertTrue(sqlrelay:sendQuery("drop table testtable")),
    assertEqualsString(sqlrelay:errorSqlState(), ""),
    io:format("~n"),
