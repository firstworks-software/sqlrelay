...
main() ->
    sqlrelay:start(),
    waitForPort(50),
    {ok, _} = sqlrelay:alloc("sqlrelay", 9004, "/tmp/sqlitetest.socket",
    ...
    sqlrelay:cacheToFile("cachefile1-sqlite"),
    sqlrelay:setCacheTtl(200),
    assertTrue(sqlrelay:sendQuery("select * from testtable order by testint")),
    {ok, Filename1} = sqlrelay:getCacheFileName(),
    assertEqualsString(Filename1, "cachefile1-sqlite"),
    sqlrelay:cacheOff(),
    ...
    assertEqualsString(Filename2, "cachefile1-sqlite"),
    sqlrelay:cacheOff(),
    ...
    sqlrelay:cacheToFile("cachefile2-sqlite"),
    assertTrue(sqlrelay:openCachedResultSet("cachefile1-sqlite")),
    sqlrelay:cacheOff(),
    assertTrue(sqlrelay:openCachedResultSet("cachefile2-sqlite")),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 0), "8"),
    assertEqualsString(sqlrelay:getFieldByIndex(8, 0), null),
    io:format("~n"),
    ...
    assertEqualsString(Filename3, "cachefile1-sqlite"),
