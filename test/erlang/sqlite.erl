...
main() ->
    ...
    sqlrelay:inputBindDouble("var2", 6.6, 4, 1),
    ...
    sqlrelay:inputBindDouble("var2", 7.7, 4, 1),
    ...
    sqlrelay:inputBindDouble("var2", 8.8, 4, 1),
    ...
    %% We still need to drop the test table so that the rest of the
    %% test works.
