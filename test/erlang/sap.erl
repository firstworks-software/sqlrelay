...
%% verifying that getIsolationLevel returns the same value.
setIsolationLevels([]) ->
    ok;
...
main() ->
    ...
    assertEqualsString(sqlrelay:identify(), "sap"),
    io:format("~n"),
    ...
    assertEqualsString(sqlrelay:getColumnTypeByName("testsmallmoney"), "SMALLMONEY"),
    ...
    assertEqualsString(sqlrelay:getColumnTypeByName("testsmalldatetime"), "SMALLDATETIME"),
    ...
    assertEqualsInt(sqlrelay:getLongestByIndex(7), 4),
    assertEqualsInt(sqlrelay:getLongestByName("testmoney"), 4),
    assertEqualsInt(sqlrelay:getLongestByIndex(8), 4),
    assertEqualsInt(sqlrelay:getLongestByName("testsmallmoney"), 4),
    assertEqualsInt(sqlrelay:getLongestByIndex(9), 19),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(0, 7), "1.00"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 8), "1.00"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 9), "Jan  1 2001  1:00AM"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 10), "Jan  1 2001  1:00AM"),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(7, 7), "8.00"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 8), "8.00"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 9), "Jan  1 2008  8:00AM"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 10), "Jan  1 2008  8:00AM"),
    ...
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(0, 7), 4),
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(0, 8), 4),
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(0, 9), 19),
    ...
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(7, 7), 4),
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(7, 8), 4),
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(7, 9), 19),
    ...
    assertEqualsString(sqlrelay:getFieldByName(0, "testmoney"), "1.00"),
    assertEqualsString(sqlrelay:getFieldByName(0, "testsmallmoney"), "1.00"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(7, "testmoney"), "8.00"),
    assertEqualsString(sqlrelay:getFieldByName(7, "testsmallmoney"), "8.00"),
    ...
    assertEqualsInt(sqlrelay:getFieldLengthByName(0, "testsmallmoney"), 4),
    ...
    assertEqualsInt(sqlrelay:getFieldLengthByName(7, "testsmallmoney"), 4),
    ...
    assertEqualsString(lists:nth(8, Row0), "1.00"),
    assertEqualsString(lists:nth(9, Row0), "1.00"),
    assertEqualsString(lists:nth(10, Row0), "Jan  1 2001  1:00AM"),
    assertEqualsString(lists:nth(11, Row0), "Jan  1 2001  1:00AM"),
    ...
    assertEqualsInt(lists:nth(8, Rowlens0), 4),
    assertEqualsInt(lists:nth(9, Rowlens0), 4),
    assertEqualsInt(lists:nth(10, Rowlens0), 19),
    ...
    sqlrelay:cacheToFile("cachefile1-sap"),
    sqlrelay:setCacheTtl(200),
    assertTrue(sqlrelay:sendQuery(
        "select * from testtable order by testint")),
    {ok, Filename1} = sqlrelay:getCacheFileName(),
    assertEqualsString(Filename1, "cachefile1-sap"),
    sqlrelay:cacheOff(),
    ...
    assertEqualsString(Filename2, "cachefile1-sap"),
    sqlrelay:cacheOff(),
    ...
    sqlrelay:cacheToFile("cachefile2-sap"),
    assertTrue(sqlrelay:openCachedResultSet("cachefile1-sap")),
    sqlrelay:cacheOff(),
    assertTrue(sqlrelay:openCachedResultSet("cachefile2-sap")),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 0), "8"),
    assertEqualsString(sqlrelay:getFieldByIndex(8, 0), null),
    io:format("~n"),
    ...
    assertEqualsString(Filename3, "cachefile1-sap"),
    ...
    %% Commit the open transaction and drop the leftover testtable so
    ...
    sqlrelay:prepareQuery("insert into testtable values (@var1,@var2)"),
    LargeBufferLength = 255,
    LargeBuf = largeBuffer(LargeBufferLength),
    sqlrelay:inputBindClob("var1", LargeBuf, LargeBufferLength),
    sqlrelay:inputBindBlob("var2", LargeBuf, LargeBufferLength),
    assertTrue(sqlrelay:executeQuery()),
    sqlrelay:sendQuery("select * from testtable"),
    ...
    assertEqualsInt(sqlrelay:countBindVariables(), 0),
    ...
    sqlrelay:defineOutputBindString("out2", 20),
    sqlrelay:defineOutputBindDouble("out3"),
    sqlrelay:defineOutputBindDate("out4"),
    sqlrelay:defineOutputBindString("out5", 20),
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsInt(sqlrelay:getOutputBindInteger("out1"), 1),
    assertEqualsString(sqlrelay:getOutputBindString("out2"), "hello"),
    assertEqualsDouble(sqlrelay:getOutputBindDouble("out3"), 2.5),
    assertEqualsInt(sqlrelay:getOutputBindDateYear("out4"), 2001),
    assertEqualsInt(sqlrelay:getOutputBindDateMonth("out4"), 2),
    assertEqualsInt(sqlrelay:getOutputBindDateDay("out4"), 3),
    assertEqualsInt(sqlrelay:getOutputBindDateHour("out4"), 0),
    assertEqualsInt(sqlrelay:getOutputBindDateMinute("out4"), 0),
    assertEqualsInt(sqlrelay:getOutputBindDateSecond("out4"), 0),
    assertEqualsInt(sqlrelay:getOutputBindDateMicrosecond("out4"), 0),
    assertEqualsString(sqlrelay:getOutputBindDateTz("out4"), ""),
    assertFalse(sqlrelay:getOutputBindDateIsNegative("out4")),
    assertEqualsString(sqlrelay:getOutputBindString("out5"), null),
    sqlrelay:getNullsAsEmptyStrings(),
    assertTrue(sqlrelay:sendQuery("drop procedure testproc")),
    io:format("~n"),
    ...
    sqlrelay:sendQuery("drop procedure testproc"),
    LargeBuf2 = largeBuffer(LargeBufferLength),
    LongProc = "create procedure testproc "
               "@bindval varchar(" ++ integer_to_list(LargeBufferLength) ++
               ") output as "
               "set @bindval='" ++ LargeBuf2 ++ "'",
    assertTrue(sqlrelay:sendQuery(LongProc)),
    sqlrelay:prepareQuery("exec testproc"),
    ...
    assertEqualsString(sqlrelay:getOutputBindString("bindval"), LargeBuf2),
    assertTrue(sqlrelay:sendQuery("drop procedure testproc")),
    io:format("~n"),
    ...
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsInt(sqlrelay:getOutputBindInteger("out1"), 1),
    sqlrelay:inputBindLong("in1", 2),
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsInt(sqlrelay:getOutputBindInteger("out1"), 2),
    sqlrelay:inputBindLong("in1", 3),
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsInt(sqlrelay:getOutputBindInteger("out1"), 3),
    assertTrue(sqlrelay:sendQuery("drop procedure testproc")),
    io:format("~n"),
    ...
    sqlrelay:prepareQuery("exec testproc"),
    sqlrelay:inputBindLong("in1", 1),
    sqlrelay:inputBindDouble("in2", 2.5, 2, 1),
    ...
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsInt(sqlrelay:getOutputBindInteger("out1"), 1),
    assertEqualsDouble(sqlrelay:getOutputBindDouble("out2"), 2.5),
    ...
    assertEqualsString(sqlrelay:getFieldByName(14, "column_name"),
                       "testtext"),
