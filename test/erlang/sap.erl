...
main() ->
    ...
    assertEqualsInt(sqlrelay:getLongestByIndex(3), 18),
    assertEqualsInt(sqlrelay:getLongestByName("testreal"), 18),
    assertEqualsInt(sqlrelay:getLongestByIndex(4), 18),
    assertEqualsInt(sqlrelay:getLongestByName("testfloat"), 18),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(7, 5), "8.8"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 6), "8.8"),
    ...
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(0, 3), 18),
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(0, 4), 18),
    ...
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(7, 3), 18),
    assertEqualsInt(sqlrelay:getFieldLengthByIndex(7, 4), 18),
    ...
    assertEqualsString(sqlrelay:getFieldByName(7, "testdecimal"), "8.8"),
    assertEqualsString(sqlrelay:getFieldByName(7, "testnumeric"), "8.8"),
    ...
    %% We still need to commit the open transaction and drop the test
    %% table so that the rest of the test works.
