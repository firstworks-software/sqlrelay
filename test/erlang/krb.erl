...
main() ->
    ...
    sqlrelay:cacheToFile("cachefile1-krb"),
    ...
    assertEqualsString(Filename1, "cachefile1-krb"),
    sqlrelay:cacheOff(),
    ...
    assertEqualsString(Filename2, "cachefile1-krb"),
    sqlrelay:cacheOff(),
    ...
    sqlrelay:cacheToFile("cachefile2-krb"),
    assertTrue(sqlrelay:openCachedResultSet("cachefile1-krb")),
    sqlrelay:cacheOff(),
    assertTrue(sqlrelay:openCachedResultSet("cachefile2-krb")),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 0), "8"),
    assertEqualsString(sqlrelay:getFieldByIndex(8, 0), null),
    io:format("~n"),
    ...
    assertEqualsString(Filename3, "cachefile1-krb"),
