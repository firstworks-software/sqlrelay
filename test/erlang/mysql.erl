...
main() ->
    ...
    assertEqualsString(sqlrelay:getColumnTypeByIndex(14), "BLOB"),
    assertEqualsString(sqlrelay:getColumnTypeByIndex(15), "TINYBLOB"),
    assertEqualsString(sqlrelay:getColumnTypeByIndex(16), "MEDIUMBLOB"),
    assertEqualsString(sqlrelay:getColumnTypeByIndex(17), "LONGBLOB"),
    ...
    assertEqualsString(sqlrelay:getColumnTypeByName("testtext"), "BLOB"),
    assertEqualsString(sqlrelay:getColumnTypeByName("testtinytext"), "TINYBLOB"),
    assertEqualsString(sqlrelay:getColumnTypeByName("testmediumtext"), "MEDIUMBLOB"),
    assertEqualsString(sqlrelay:getColumnTypeByName("testlongtext"), "LONGBLOB"),
    ...
    TableTypeFound = searchTableType(0, TableTypeRowCount),
...
%% Walk the table-type-list result looking for a "TABLE" row.
