...
%%
%% Helpers for the main test
%%

%% Build a string full of 'C' of the given length.
largeBuffer(Length) ->
...
main() ->
    ...
    %% hostname - strip trailing domain
    {ok, Hostname0} = inet:gethostname(),
    Hostname = case string:chr(Hostname0, $.) of
                   0 -> Hostname0;
                   N -> string:substr(Hostname0, 1, N - 1)
               end,
