...
main() ->
    ...
    sqlrelay:cacheToFile("cachefile1-tls"),
    ...
    assertEqualsString(Filename1, "cachefile1-tls"),
    sqlrelay:cacheOff(),
    ...
    assertEqualsString(Filename2, "cachefile1-tls"),
    sqlrelay:cacheOff(),
    ...
    sqlrelay:cacheToFile("cachefile2-tls"),
    assertTrue(sqlrelay:openCachedResultSet("cachefile1-tls")),
    sqlrelay:cacheOff(),
    assertTrue(sqlrelay:openCachedResultSet("cachefile2-tls")),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 0), "8"),
    assertEqualsString(sqlrelay:getFieldByIndex(8, 0), null),
    io:format("~n"),
    ...
    assertEqualsString(Filename3, "cachefile1-tls"),
    ...
    assertEqualsString(sqlrelay:getColumnName(0), "Database"),
    assertInResultSet("Database", string:to_upper(Hostname)),
    io:format("~n"),
    ...
    assertStartsWith(KeyName2, "SYS_C"),
    assertTrue(sqlrelay:sendQuery("drop table testtable")),
    io:format("~n"),
