...
main() ->
    ...
    sqlrelay:inputBindDouble("7", 2.2, 4, 2),
    sqlrelay:inputBindDouble("8", 2.2, 4, 2),
    sqlrelay:inputBindDouble("9", 2.2, 4, 2),
    ...
    sqlrelay:inputBindDouble("7", 3.3, 4, 2),
    sqlrelay:inputBindDouble("8", 3.3, 4, 2),
    sqlrelay:inputBindDouble("9", 3.3, 4, 2),
    ...
    sqlrelay:inputBindDouble("7", 4.4, 4, 2),
    sqlrelay:inputBindDouble("8", 4.4, 4, 2),
    sqlrelay:inputBindDouble("9", 4.4, 4, 2),
    ...
    sqlrelay:inputBindDouble("7", 6.6, 4, 2),
    sqlrelay:inputBindDouble("8", 6.6, 4, 2),
    sqlrelay:inputBindDouble("9", 6.6, 4, 2),
    ...
    sqlrelay:inputBindString("7", "7.7"),
    sqlrelay:inputBindString("8", "7.7"),
    sqlrelay:inputBindString("9", "7.7"),
    ...
    sqlrelay:inputBindDouble("7", 8.8, 4, 2),
    sqlrelay:inputBindDouble("8", 8.8, 4, 2),
    sqlrelay:inputBindDouble("9", 8.8, 4, 2),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(0, 5), "1.10"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 6), "1.10"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 7), "1.1"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 8), "1.1"),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(7, 5), "8.80"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 6), "8.80"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 7), "8.8"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 8), "8.8"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(0, "testmoney"), "1.10"),
    assertEqualsString(sqlrelay:getFieldByName(0, "testsmallfloat"), "1.1"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(7, "testmoney"), "8.80"),
    assertEqualsString(sqlrelay:getFieldByName(7, "testsmallfloat"), "8.8"),
    ...
    assertEqualsString(lists:nth(6, Row0), "1.10"),
    assertEqualsString(lists:nth(7, Row0), "1.10"),
    assertEqualsString(lists:nth(8, Row0), "1.1"),
    assertEqualsString(lists:nth(9, Row0), "1.1"),
    ...
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsInt(sqlrelay:getOutputBindInteger("4"), 1),
    assertEqualsDouble(sqlrelay:getOutputBindDouble("5"), 1.1),
    ...
    TableTypeFound = searchTableTypes(0, TableTypeRowCount),
    ...
    assertFalse(contains(Ex2, "auto_increment")),
    ...
    assertEqualsString(sqlrelay:getFieldByName(0, "ordinal_position"), "0"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(1, "ordinal_position"), "1"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(2, "ordinal_position"), "2"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(3, "ordinal_position"), "3"),
...
%% column is "TABLE".
searchTableTypes(I, Count) when I >= Count ->
    false;
searchTableTypes(I, Count) ->
    case sqlrelay:getFieldByName(I, "table_type") of
        {ok, "TABLE"} -> true;
        _             -> searchTableTypes(I + 1, Count)
    end.
