...
main() ->
    ...
    sqlrelay:inputBindDouble("3", 2.5, 2, 1),
    ...
    sqlrelay:inputBindDouble("3", 3.5, 2, 1),
    ...
    sqlrelay:inputBindDouble("3", 4.5, 2, 1),
    ...
    sqlrelay:inputBindDouble("3", 6.5, 2, 1),
    ...
    sqlrelay:inputBindString("3", "7.5"),
    ...
    sqlrelay:inputBindDouble("3", 8.5, 2, 1),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(0, 2), "1.50"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 3), "1.50"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 4), "1.5000"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 5), "1.5000"),
    ...
    assertEqualsString(sqlrelay:getFieldByIndex(7, 2), "8.50"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 3), "8.50"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 4), "8.5000"),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 5), "8.5000"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(0, "TESTNUMERIC"), "1.50"),
    assertEqualsString(sqlrelay:getFieldByName(0, "TESTFLOAT"), "1.5000"),
    assertEqualsString(sqlrelay:getFieldByName(0, "TESTDOUBLE"), "1.5000"),
    ...
    assertEqualsString(sqlrelay:getFieldByName(7, "TESTNUMERIC"), "8.50"),
    assertEqualsString(sqlrelay:getFieldByName(7, "TESTFLOAT"), "8.5000"),
    assertEqualsString(sqlrelay:getFieldByName(7, "TESTDOUBLE"), "8.5000"),
    ...
    assertEqualsString(lists:nth(3, Row0), "1.50"),
    assertEqualsString(lists:nth(4, Row0), "1.50"),
    assertEqualsString(lists:nth(5, Row0), "1.5000"),
    assertEqualsString(lists:nth(6, Row0), "1.5000"),
    ...
    sqlrelay:cacheToFile("cachefile1-firebird"),
    ...
    assertEqualsString(Filename1, "cachefile1-firebird"),
    sqlrelay:cacheOff(),
    ...
    assertEqualsString(Filename2, "cachefile1-firebird"),
    sqlrelay:cacheOff(),
    ...
    sqlrelay:cacheToFile("cachefile2-firebird"),
    assertTrue(sqlrelay:openCachedResultSet("cachefile1-firebird")),
    sqlrelay:cacheOff(),
    assertTrue(sqlrelay:openCachedResultSet("cachefile2-firebird")),
    assertEqualsString(sqlrelay:getFieldByIndex(7, 0), "8"),
    assertEqualsString(sqlrelay:getFieldByIndex(8, 0), null),
    io:format("~n"),
    ...
    assertEqualsString(Filename3, "cachefile1-firebird"),
    ...
    %% NULL AND EMPTY LOBS
    %% the Erlang inputBindBlob function requires a list Value, so a true
    %% NULL cannot be bound; the blob is bound as an empty string and
    %% round-trips as an empty string (the true-NULL LOB case is
    %% exercised by the c++ test)
    ...
    {ok, OutDbl} = sqlrelay:getOutputBindDouble("2"),
    assertEqualsDouble(OutDbl, 1.5),
    ...
    assertTrue(sqlrelay:executeQuery()),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 0), "1"),
    assertEqualsString(sqlrelay:getFieldByIndex(0, 1), "1.5000"),
