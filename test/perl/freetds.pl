...
assertEqualsBytes($cur->getField(7,5),"8.8",3);
assertEqualsBytes($cur->getField(7,6),"8.8",3);
...
assertEqualsBytes($cur->getField(7,"testdecimal"),"8.8",3);
assertEqualsBytes($cur->getField(7,"testnumeric"),"8.8",3);
