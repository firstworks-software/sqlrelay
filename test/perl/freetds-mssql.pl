...
# instantiation
$con=SQLRelay::Connection->new("sqlrelay",9032,"/tmp/freetds-mssql.socket",
...
assertEquals($cur->getColumnLength(14),16);
assertEquals($cur->getColumnLength("testdate"),16);
assertEquals($cur->getColumnLength(15),16);
assertEquals($cur->getColumnLength("testtime"),16);
assertEquals($cur->getColumnLength(16),16);
assertEquals($cur->getColumnLength("testdatetime2"),16);
print("\n");
...
assertEquals($cur->getLongest("testdatetime2"),26);
print("\n");
...
assertEquals($cur->getField(0,"testdatetime2"),"Jan  1 2001 01:01:01:000PM");
print("\n");
...
assertEquals($cur->getField(7,"testdatetime2"),"Jan  1 2001 01:01:01:000PM");
print("\n");
...
assertEquals($cur->getFieldLength(0,"testdatetime2"),26);
print("\n");
...
assertEquals($cur->getFieldLength(7,"testdatetime2"),26);
print("\n");
...
assertEquals($filename,"cachefile1-freetds-mssql");
$cur->cacheOff();
...
$secondcon=SQLRelay::Connection->new("sqlrelay",9032,"/tmp/freetds-mssql.socket",
						"testuser","testpassword",0,1);
...
# is fixed.
assertEquals($cur->getField(0,0),"\0" x 32768);
...
# validateBinds() can't be used for output binds here.  When
