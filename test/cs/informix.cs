...
namespace SQLRClientTest
{
    class InformixTest : SQLRTest
    {
        public static int Main(string[] args)
        {
            ...
            assertEquals(cur.getField((UInt64)0, "ordinal_position"), "0");
            ...
            assertEquals(cur.getField((UInt64)1, "ordinal_position"), "1");
            ...
            assertEquals(cur.getField((UInt64)2, "ordinal_position"), "2");
            ...
            assertEquals(cur.getField((UInt64)3, "ordinal_position"), "3");
