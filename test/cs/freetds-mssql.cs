...
{
    class FreetdsMssqlTest : SQLRTest
    {
        public static int Main(string[] args)
        {
            ...
            // instantiation
            con = new SQLRConnection("sqlrelay", 9032, "/tmp/freetds-mssql.socket",
            ...
            assertEquals(cur.getColumnLength(14), (UInt32)16);
            assertEquals(cur.getColumnLength("testdate"), (UInt32)16);
            assertEquals(cur.getColumnLength(15), (UInt32)16);
            assertEquals(cur.getColumnLength("testtime"), (UInt32)16);
            assertEquals(cur.getColumnLength(16), (UInt32)16);
            assertEquals(cur.getColumnLength("testdatetime2"), (UInt32)16);
            Console.WriteLine("");
            ...
            assertEquals(cur.getLongest("testdatetime2"), (UInt32)26);
            Console.WriteLine("");
            ...
            assertEquals(cur.getField((UInt64)0,"testdatetime2"),"Jan  1 2001 01:01:01:000PM");
            Console.WriteLine("");
            ...
            assertEquals(cur.getField((UInt64)7,"testdatetime2"),"Jan  1 2001 01:01:01:000PM");
            Console.WriteLine("");
            ...
            assertEquals(cur.getFieldLength((UInt64)0,"testdatetime2"),(UInt32)26);
            Console.WriteLine("");
            ...
            assertEquals(cur.getFieldLength((UInt64)7,"testdatetime2"),(UInt32)26);
            Console.WriteLine("");
            ...
            secondcon = new SQLRConnection("sqlrelay", 9032, "/tmp/freetds-mssql.socket",
                                    "testuser", "testpassword", 0, 1);
