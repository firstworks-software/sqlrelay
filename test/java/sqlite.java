...
class sqlite extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		assertEquals(
			cur.getColumnType(0),"INTEGER");
		assertEquals(
			cur.getColumnType("testint"),
			"INTEGER");
		assertEquals(
			cur.getColumnType(1),"FLOAT");
		assertEquals(
			cur.getColumnType("testfloat"),
			"FLOAT");
		assertEquals(
			cur.getColumnType(2),"STRING");
		assertEquals(
			cur.getColumnType("testchar"),
			"STRING");
		assertEquals(
			cur.getColumnType(3),"STRING");
		assertEquals(
			cur.getColumnType("testvarchar"),
			"STRING");
		assertEquals(
			cur.getColumnType(4),"STRING");
		assertEquals(
			cur.getColumnType("testclob"),
			"STRING");
		assertEquals(
			cur.getColumnType(5),"STRING");
		assertEquals(
		...
		assertEquals(
			cur.getColumnLength("testchar"),0);
		...
		assertEquals(
			cur.getField(0,2),"testchar1");
		assertEquals(
			cur.getField(0,3),
			"testvarchar1");
		assertEquals(
			cur.getField(0,4),"testclob1");
		assertEquals(
			cur.getField(0,5),"testblob1");
		System.out.println();
		assertEquals(
			cur.getField(7,0),"8");
		assertEquals(
			cur.getField(7,1),"8.8");
		assertEquals(
			cur.getField(7,2),"testchar8");
		assertEquals(
			cur.getField(7,3),
			"testvarchar8");
		assertEquals(
			cur.getField(7,4),"testclob8");
		assertEquals(
			cur.getField(7,5),"testblob8");
		System.out.println();
		...
		assertEquals(
			cur.getFieldLength(0,2),9);
		assertEquals(
			cur.getFieldLength(0,3),12);
		assertEquals(
			cur.getFieldLength(0,4),9);
		assertEquals(
			cur.getFieldLength(0,5),9);
		System.out.println();
		assertEquals(
		...
		assertEquals(
			cur.getFieldLength(7,2),9);
		assertEquals(
			cur.getFieldLength(7,3),12);
		assertEquals(
			cur.getFieldLength(7,4),9);
		assertEquals(
			cur.getFieldLength(7,5),9);
		System.out.println();
		...
		assertEquals(
			...
			12);
		assertEquals(
			cur.getFieldLength(7,"testclob"),
			9);
		assertEquals(
			cur.getFieldLength(7,"testblob"),
			9);
		System.out.println();
		...
		assertEquals(
			...
			"testvarchar");
		assertEquals(
			cur.getColumnName(4),"testclob");
		assertEquals(
			cur.getColumnName(5),"testblob");
		cols=cur.getColumnNames();
		assertEquals(cols[0],"testint");
		assertEquals(cols[1],"testfloat");
		assertEquals(cols[2],"testchar");
		...
		assertTrue(extra0!=null &&
			extra0.contains(
			"auto_increment"));
		String colkey0=
			cur.getField(0,"column_key");
		assertTrue(colkey0!=null &&
			colkey0.contains("PRI"));
		String extra1=
			cur.getField(1,"extra");
		assertFalse(extra1!=null &&
			extra1.contains(
			"auto_increment"));
		String colkey1=
			cur.getField(1,"column_key");
		assertFalse(colkey1!=null &&
			colkey1.contains("PRI"));
		System.out.println();
		assertTrue(cur.sendQuery(
			"drop table if exists "+
			"testtable"));
