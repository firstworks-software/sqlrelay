...
class sap extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		assertEquals(cur.getOutputBindDateYear("4"),2001);
		assertEquals(cur.getOutputBindDateMonth("4"),2);
		assertEquals(cur.getOutputBindDateDay("4"),3);
		assertEquals(cur.getOutputBindDateHour("4"),0);
		assertEquals(cur.getOutputBindDateMinute("4"),0);
		assertEquals(cur.getOutputBindDateSecond("4"),0);
		assertEquals(cur.getOutputBindDateMicrosecond("4"),0);
		assertEquals(cur.getOutputBindDateTz("4"),"");
		...
		assertEquals(stringvar,"hello");
		assertEquals(floatvar,2.5);
		assertEquals(cur.getOutputBindDateYear("out4"),2001);
		assertEquals(cur.getOutputBindDateMonth("out4"),2);
		assertEquals(cur.getOutputBindDateDay("out4"),3);
		assertEquals(cur.getOutputBindDateHour("out4"),0);
		assertEquals(cur.getOutputBindDateMinute("out4"),0);
		assertEquals(cur.getOutputBindDateSecond("out4"),0);
		assertEquals(cur.getOutputBindDateMicrosecond("out4"),0);
		assertEquals(cur.getOutputBindDateTz("out4"),"");
		assertEquals(cur.getOutputBindString("out5"),null);
		cur.getNullsAsEmptyStrings();
		assertTrue(cur.sendQuery("drop procedure testproc"));
		System.out.println();
