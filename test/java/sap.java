...
class sap extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		cur.inputBindBlob("16",new byte[]{0x02},1);
		cur.inputBindBlob("17",new byte[]{0x02},1);
		...
		cur.inputBindBlob("16",new byte[]{0x03},1);
		cur.inputBindBlob("17",new byte[]{0x03},1);
		...
		cur.inputBindBlob("16",new byte[]{0x04},1);
		cur.inputBindBlob("17",new byte[]{0x04},1);
		...
		cur.inputBindBlob("var16",new byte[]{0x05},1);
		cur.inputBindBlob("var17",new byte[]{0x05},1);
		...
		cur.inputBindBlob("var16",new byte[]{0x06},1);
		cur.inputBindBlob("var17",new byte[]{0x06},1);
		...
		cur.inputBindBlob("var16",new byte[]{0x07},1);
		cur.inputBindBlob("var17",new byte[]{0x07},1);
		...
		cur.inputBindBlob("var16",new byte[]{0x08},1);
		cur.inputBindBlob("var17",new byte[]{0x08},1);
