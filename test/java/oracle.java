...
class oracle extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		assertTrue(con.commit());
		assertTrue(con.setIsolationLevel(
						isolationlevels[0]));
		System.out.println();
		...
		cur.inputBindBlob("7",
			(new String("testblob2")).getBytes(),9);
		...
		cur.inputBindBlob("7",
			(new String("testblob3")).getBytes(),9);
		assertTrue(cur.executeQuery());
		System.out.println();
		...
		assertEquals(cur.getColumnType("TESTNUMBER"),
							"NUMBER");
		assertEquals(cur.getColumnType(1),"CHAR");
		assertEquals(cur.getColumnType("TESTCHAR"),
							"CHAR");
		assertEquals(cur.getColumnType(2),"VARCHAR2");
		assertEquals(cur.getColumnType("TESTVARCHAR"),
							"VARCHAR2");
		assertEquals(cur.getColumnType(3),"DATE");
		assertEquals(cur.getColumnType("TESTDATE"),
							"DATE");
		assertEquals(cur.getColumnType(4),"LONG");
		assertEquals(cur.getColumnType("TESTLONG"),
							"LONG");
		assertEquals(cur.getColumnType(5),"CLOB");
		assertEquals(cur.getColumnType("TESTCLOB"),
							"CLOB");
		assertEquals(cur.getColumnType(6),"BLOB");
		assertEquals(cur.getColumnType("TESTBLOB"),
							"BLOB");
		System.out.println();
		...
		assertEquals(cur.getColumnLength("TESTNUMBER"),
								22);
		assertEquals(cur.getColumnLength(1),40);
		assertEquals(cur.getColumnLength("TESTCHAR"),
								40);
		assertEquals(cur.getColumnLength(2),40);
		assertEquals(
			cur.getColumnLength("TESTVARCHAR"),40);
		assertEquals(cur.getColumnLength(3),7);
		assertEquals(cur.getColumnLength("TESTDATE"),
								7);
		assertEquals(cur.getColumnLength(4),0);
		assertEquals(cur.getColumnLength("TESTLONG"),
								0);
		assertEquals(cur.getColumnLength(5),0);
		assertEquals(cur.getColumnLength("TESTCLOB"),
								0);
		assertEquals(cur.getColumnLength(6),0);
		assertEquals(cur.getColumnLength("TESTBLOB"),
								0);
		System.out.println();
		...
		assertEquals(cur.getField(7,1),
			"testchar8"+
			"                               ");
		assertEquals(cur.getField(7,2),
						"testvarchar8");
		...
		assertEquals(cur.getField(0,"TESTNUMBER"),
								"1");
		assertEquals(cur.getField(0,"TESTCHAR"),
			"testchar1"+
			"                               ");
		assertEquals(cur.getField(0,"TESTVARCHAR"),
						"testvarchar1");
		assertEquals(cur.getField(0,"TESTDATE"),
						"01-JAN-01");
		assertEquals(cur.getField(0,"TESTLONG"),
						"testlong1");
		assertEquals(cur.getField(0,"TESTCLOB"),
						"testclob1");
		assertEquals(cur.getField(0,"TESTBLOB"),"");
		System.out.println();
		assertEquals(cur.getField(7,"TESTNUMBER"),
								"8");
		assertEquals(cur.getField(7,"TESTCHAR"),
			"testchar8"+
			"                               ");
		assertEquals(cur.getField(7,"TESTVARCHAR"),
						"testvarchar8");
		assertEquals(cur.getField(7,"TESTDATE"),
						"01-JAN-08");
		assertEquals(cur.getField(7,"TESTLONG"),
						"testlong8");
		assertEquals(cur.getField(7,"TESTCLOB"),
						"testclob8");
		assertEquals(cur.getField(7,"TESTBLOB"),
						"testblob8");
		System.out.println();
		...
		System.out.println(
				"FIELD LENGTHS BY NAME: ");
		assertEquals(
			cur.getFieldLength(0,"TESTNUMBER"),1);
		assertEquals(
			cur.getFieldLength(0,"TESTCHAR"),40);
		assertEquals(
			cur.getFieldLength(0,"TESTVARCHAR"),
								12);
		assertEquals(
			cur.getFieldLength(0,"TESTDATE"),9);
		assertEquals(
			cur.getFieldLength(0,"TESTLONG"),9);
		assertEquals(
			cur.getFieldLength(0,"TESTCLOB"),9);
		assertEquals(
			cur.getFieldLength(0,"TESTBLOB"),0);
		System.out.println();
		assertEquals(
			cur.getFieldLength(7,"TESTNUMBER"),1);
		assertEquals(
			cur.getFieldLength(7,"TESTCHAR"),40);
		assertEquals(
			cur.getFieldLength(7,"TESTVARCHAR"),
								12);
		assertEquals(
			cur.getFieldLength(7,"TESTDATE"),9);
		assertEquals(
			cur.getFieldLength(7,"TESTLONG"),9);
		assertEquals(
			cur.getFieldLength(7,"TESTCLOB"),9);
		assertEquals(
			cur.getFieldLength(7,"TESTBLOB"),9);
		System.out.println();
		...
		assertTrue(cur.openCachedResultSet(
						"cachefile1"));
		cur.cacheOff();
		assertTrue(cur.openCachedResultSet(
						"cachefile2"));
		...
		System.out.println();
		assertTrue(con.resumeSession(port,socket));
		assertTrue(cur.resumeCachedResultSet(
						id,filename));
		System.out.println();
		assertEquals(cur.firstRowIndex(),4);
		assertFalse(cur.endOfResultSet());
...
System.out.println("now here");
		...
		cur.prepareQuery(
			"select $(var1),$(var2),"+
			"$(var3) from dual");
		cur.substitutions(subvars,subvaldoubles,
						precs,scales);
		assertTrue(cur.executeQuery());
		...
		cur.inputBindClob("clobval",
			largebuffer.toString(),
			LARGE_BUFFER_LENGTH);
		cur.inputBindBlob("blobval",
		...
		assertEquals(
			cur.getOutputBindString("5"),null);
		cur.getNullsAsEmptyStrings();
		System.out.println();
		...
		stringvar=
			cur.getOutputBindString("stringvar");
		floatvar=
			cur.getOutputBindDouble("floatvar");
		assertEquals(numvar,1);
		assertEquals(stringvar,"hello");
		assertEquals(floatvar,2.5);
		assertEquals(
		...
		clobvarlength=
			cur.getOutputBindLength("clobvar");
		blobvar=cur.getOutputBindBlob("blobvar");
		blobvarlength=
			cur.getOutputBindLength("blobvar");
		...
		cur.defineOutputBindString("bindval",
					LARGE_BUFFER_LENGTH);
		assertTrue(cur.executeQuery());
		assertEquals(
			cur.getOutputBindLength("bindval"),
			LARGE_BUFFER_LENGTH);
		assertEquals(
			cur.getOutputBindString("bindval"),
			lobuf.toString());
		System.out.println();
		...
		assertTrue(cur.executeQuery());
		assertEquals(
			cur.getOutputBindInteger("out"),1);
		cur.inputBind("in",2);
		assertTrue(cur.executeQuery());
		assertEquals(
			cur.getOutputBindInteger("out"),2);
		cur.inputBind("in",3);
		assertTrue(cur.executeQuery());
		assertEquals(
			cur.getOutputBindInteger("out"),3);
		System.out.println();
		...
		assertTrue(cur.executeQuery());
		assertEquals(
			cur.getOutputBindInteger("out1"),1);
		assertTrue(cur.sendQuery(
		...
		assertEquals(
			cur.getOutputBindInteger("out1"),1);
		assertEquals(
			cur.getOutputBindDouble("out2"),1.1);
		assertEquals(
		...
		assertTrue(cur.executeQuery());
		SQLRCursor bindcur1=
			cur.getOutputBindCursor("curs1");
		assertTrue(
			bindcur1.fetchFromBindCursor());
		assertEquals(
			bindcur1.getField(0,0),"6");
		assertEquals(
			bindcur1.getField(1,0),"7");
		assertEquals(
			bindcur1.getField(2,0),"8");
		SQLRCursor bindcur2=
			cur.getOutputBindCursor("curs2");
		assertTrue(
			bindcur2.fetchFromBindCursor());
		assertEquals(
			bindcur2.getField(0,0),"1");
		assertEquals(
			bindcur2.getField(1,0),"2");
		assertEquals(
			bindcur2.getField(2,0),"3");
		assertTrue(cur.sendQuery(
			"drop function testproc"));
		assertTrue(cur.sendQuery(
			"drop package types"));
		...
		assertEquals(cur.getColumnName(0),
						"table_type");
		assertEquals(
			cur.getField(0,"table_type"),
			"SYNONYM");
		assertEquals(
			cur.getField(1,"table_type"),
			"TABLE");
		assertEquals(
			cur.getField(2,"table_type"),
			"VIEW");
		System.out.println();
		...
		counter=0;
		for (long i=0; i<cur.rowCount(); i++) {
			String name=cur.getField((int)i,
					"Tables_in_xxx");
		...
		assertEquals(cur.getColumnName(11),
					"auto_increment");
		assertEquals(cur.getColumnName(12),
					"local_type_name");
		assertEquals(cur.getColumnName(13),
					"minumum_scale");
		assertEquals(cur.getColumnName(14),
					"maxiumm_scale");
		assertEquals(cur.getColumnName(15),
					"sql_data_type");
		assertEquals(cur.getColumnName(16),
					"sql_datetime_sub");
		assertEquals(cur.getColumnName(17),
					"num_prec_radix");
		assertEquals(cur.getColumnName(18),
				"interval_precision");
		assertEquals(
			cur.getField(0,"type_name"),
			"NUMBER");
		assertEquals(
			cur.getField(0,"data_type"),"-7");
		assertEquals(
			cur.getField(0,"precision"),"1");
		assertEquals(
			cur.getField(0,"local_type_name"),
			"NUMBER");
		assertTrue(
		...
		assertEquals(
			...
			"CHAR");
		assertTrue(
			cur.getTypeInfoList("varchar2"));
		assertEquals(
			cur.getField(0,"type_name"),
			"VARCHAR2");
		assertEquals(
			cur.getField(0,"data_type"),"12");
		assertEquals(
			cur.getField(0,"precision"),
			"32767");
		assertEquals(
		...
		assertEquals(
			...
			"DATE");
		assertEquals(
			cur.getField(0,"data_type"),"92");
		assertEquals(
			cur.getField(0,"precision"),"7");
		assertEquals(
			cur.getField(0,"local_type_name"),
			"DATE");
		System.out.println();
		...
		assertTrue(cur.getColumnList(
					"testtable",null));
		assertTrue(
			cur.getField(0,"column_key")
				.contains("PRI"));
		assertFalse(
			cur.getField(1,"column_key")
				.contains("PRI"));
		assertTrue(cur.sendQuery(
			"drop table testtable"));
		System.out.println();
		...
		assertTrue(cur.sendQuery(
			...
			"	col1 number primary key, "+
			"	col2 number)"));
		assertTrue(cur.getPrimaryKeysList(
					"testtable",null));
		assertEquals(cur.getColumnName(0),
						"table");
		assertEquals(cur.getColumnName(1),
		...
		assertTrue(cur.sendQuery(
			...
			"	col1 number primary key, "+
			"	col2 number)"));
		assertTrue(cur.getKeyAndIndexList(
					"testtable",null));
		assertEquals(cur.getColumnName(0),
						"table");
		assertEquals(cur.getColumnName(1),
		...
		assertEquals(cur.rowCount(),4);
		assertEquals(
			cur.getField(0,"parameter_name"),
			"IN1");
		assertEquals(
			cur.getField(0,"parameter_mode"),
			"1");
		assertEquals(
			cur.getField(0,"data_type"),
			"NUMBER");
		assertEquals(
			cur.getField(0,"ordinal_position"),
			"1");
		assertEquals(
			cur.getField(1,"parameter_name"),
			"IN2");
		assertEquals(
			cur.getField(1,"parameter_mode"),
			"1");
		assertEquals(
			cur.getField(1,"data_type"),
			"CHAR");
		assertEquals(
			cur.getField(1,"ordinal_position"),
			"2");
		assertEquals(
			cur.getField(2,"parameter_name"),
			"IN3");
		assertEquals(
			cur.getField(2,"parameter_mode"),
			"1");
		assertEquals(
			cur.getField(2,"data_type"),
			"VARCHAR2");
		assertEquals(
			cur.getField(2,"ordinal_position"),
			"3");
		assertEquals(
			cur.getField(3,"parameter_name"),
			"IN4");
		assertEquals(
			cur.getField(3,"parameter_mode"),
			"1");
		assertEquals(
			cur.getField(3,"data_type"),
			"DATE");
		assertEquals(
			cur.getField(3,"ordinal_position"),
			"4");
		assertTrue(cur.sendQuery(
			"drop procedure testproc1"));
		assertTrue(cur.sendQuery(
