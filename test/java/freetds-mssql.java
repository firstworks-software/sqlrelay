...
class freetds_mssql extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		// instantiation
		SQLRConnection con=new SQLRConnection("sqlrelay",(short)9032,
					"/tmp/freetds-mssql.socket","testuser",
					"testpassword",0,1);
		...
		SQLRConnection secondcon=new SQLRConnection("sqlrelay",
				(short)9032,"/tmp/freetds-mssql.socket","testuser",
				"testpassword",0,1);
		...
		*/
		...
		// variable delimiters in the query.  eg, you just do: "exec testproc", not
