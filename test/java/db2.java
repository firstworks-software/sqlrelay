...
class db2 extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		cur.inputBind("9",
			(short)2002,(short)1,(short)1,(short)-1,(short)-1,(short)-1,(short)-1,null,false);
		cur.inputBind("10",
			(short)-1,(short)-1,(short)-1,(short)2,(short)0,(short)0,(short)0,null,false);
		cur.inputBindClob(
			"11","testclob2",9);
		cur.inputBindBlob("12",
			(new String("testblob2"))
				.getBytes(),9);
		...
		cur.inputBind("9",
			(short)2003,(short)1,(short)1,(short)-1,(short)-1,(short)-1,(short)-1,null,false);
		cur.inputBind("10",
			(short)-1,(short)-1,(short)-1,(short)3,(short)0,(short)0,(short)0,null,false);
		cur.inputBindClob(
			"11","testclob3",9);
		cur.inputBindBlob("12",
			(new String("testblob3"))
				.getBytes(),9);
		assertTrue(cur.executeQuery());
		cur.clearBinds();
		cur.inputBind("1",4);
		...
		cur.inputBind("9",
			(short)2004,(short)1,(short)1,(short)-1,(short)-1,(short)-1,(short)-1,null,false);
		cur.inputBind("10",
			(short)-1,(short)-1,(short)-1,(short)4,(short)0,(short)0,(short)0,null,false);
		cur.inputBindClob(
			"11","testclob4",9);
		cur.inputBindBlob("12",
			(new String("testblob4"))
				.getBytes(),9);
		assertTrue(cur.executeQuery());
		cur.clearBinds();
		cur.inputBind("1",5);
		...
		cur.inputBind("9",
			(short)2005,(short)1,(short)1,(short)-1,(short)-1,(short)-1,(short)-1,null,false);
		cur.inputBind("10",
			(short)-1,(short)-1,(short)-1,(short)5,(short)0,(short)0,(short)0,null,false);
		cur.inputBindClob(
			"11","testclob5",9);
		cur.inputBindBlob("12",
			(new String("testblob5"))
				.getBytes(),9);
		assertTrue(cur.executeQuery());
		cur.clearBinds();
		cur.inputBind("1",6);
		...
		cur.inputBind("9",
			(short)2006,(short)1,(short)1,(short)-1,(short)-1,(short)-1,(short)-1,null,false);
		cur.inputBind("10",
			(short)-1,(short)-1,(short)-1,(short)6,(short)0,(short)0,(short)0,null,false);
		cur.inputBindClob(
			"11","testclob6",9);
		cur.inputBindBlob("12",
			(new String("testblob6"))
				.getBytes(),9);
		assertTrue(cur.executeQuery());
		System.out.println();
		...
		cur.inputBind("9",
			(short)2008,(short)1,(short)1,(short)-1,(short)-1,(short)-1,(short)-1,null,false);
		cur.inputBind("10",
			(short)-1,(short)-1,(short)-1,(short)8,(short)0,(short)0,(short)0,null,false);
		cur.inputBindClob(
			"11","testclob8",9);
		cur.inputBindBlob("12",
			(new String("testblob8"))
				.getBytes(),9);
		cur.validateBinds();
		assertTrue(cur.executeQuery());
		System.out.println();
		...
		assertEquals(
			cur.getColumnLength(0),2);
		assertEquals(
			cur.getColumnLength(
				"TESTSMALLINT"),2);
		assertEquals(
			cur.getColumnLength(1),4);
		assertEquals(
			cur.getColumnLength(
				"TESTINT"),4);
		assertEquals(
			cur.getColumnLength(2),8);
		assertEquals(
			cur.getColumnLength(
				"TESTBIGINT"),8);
		assertEquals(
			cur.getColumnLength(3),12);
		assertEquals(
			cur.getColumnLength(
				"TESTDECIMAL"),12);
		assertEquals(
			cur.getColumnLength(4),4);
		assertEquals(
			cur.getColumnLength(
				"TESTREAL"),4);
		assertEquals(
			cur.getColumnLength(5),8);
		assertEquals(
			cur.getColumnLength(
				"TESTDOUBLE"),8);
		assertEquals(
			cur.getColumnLength(6),40);
		assertEquals(
			cur.getColumnLength(
				"TESTCHAR"),40);
		assertEquals(
			cur.getColumnLength(7),40);
		assertEquals(
			cur.getColumnLength(
				"TESTVARCHAR"),40);
		assertEquals(
			cur.getColumnLength(8),6);
		assertEquals(
			cur.getColumnLength(
				"TESTDATE"),6);
		assertEquals(
			cur.getColumnLength(9),6);
		assertEquals(
			cur.getColumnLength(
				"TESTTIME"),6);
		assertEquals(
			cur.getColumnLength(10),16);
		assertEquals(
			cur.getColumnLength(
				"TESTTIMESTAMP"),16);
		System.out.println();
		...
		assertEquals(
			cur.getFieldLength(0,6),40);
		assertEquals(
			cur.getFieldLength(0,7),12);
		assertEquals(
		...
		assertEquals(
			cur.getFieldLength(7,6),40);
		assertEquals(
			cur.getFieldLength(7,7),12);
		assertEquals(
		...
		assertTrue(cur.executeQuery());
		clobvar=
			cur.getOutputBindClob("1");
		clobvarlength=
			cur.getOutputBindLength("1");
		blobvar=
			cur.getOutputBindBlob("2");
		blobvarlength=
			cur.getOutputBindLength("2");
		...
		assertTrue(cur.executeQuery());
		assertEquals(
			cur.getOutputBindInteger("6"),
			1);
		assertEquals(
			cur.getOutputBindDouble("7"),
			1.1);
		assertEquals(
			cur.getOutputBindString("8"),
			"hello");
		assertEquals(
			cur.getOutputBindClob("9"),
			"clob");
		assertEquals(
			cur.getOutputBindBlob("10"),
			"blob",4);
		assertTrue(cur.sendQuery(
			"drop procedure testproc"));
		assertTrue(con.commit());
