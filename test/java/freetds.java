...
class freetds extends sqlrtest {
	...
	public static void	main(String[] args) {
		...
		assertEquals(
			cur.getColumnType("testdatetime"),
			"DATETIME");
		assertEquals(
		...
		assertEquals(
			cur.getColumnLength(1),2);
		assertEquals(
			cur.getColumnLength(
				"testsmallint"),2);
		assertEquals(
			cur.getColumnLength(2),1);
		assertEquals(
			cur.getColumnLength(
				"testtinyint"),1);
		assertEquals(
			cur.getColumnLength(3),4);
		assertEquals(
			cur.getColumnLength("testreal"),4);
		assertEquals(
			cur.getColumnLength(4),8);
		assertEquals(
		...
		//		"testnumeric"),3);
		assertEquals(
			cur.getColumnLength(7),8);
		assertEquals(
			cur.getColumnLength("testmoney"),
			8);
		assertEquals(
			cur.getColumnLength(8),4);
		assertEquals(
			cur.getColumnLength(
				"testsmallmoney"),4);
		assertEquals(
			cur.getColumnLength(9),8);
		assertEquals(
			cur.getColumnLength(
				"testdatetime"),8);
		assertEquals(
		...
		// freetds release
		//assertEquals(
		//	cur.getField(7,3),"8.8");
		//assertEquals(
		//	cur.getField(7,4),"8.8");
		assertEquals(
			cur.getField(7,5),"8.8",3);
		assertEquals(
			cur.getField(7,6),"8.8",3);
		//assertEquals(
		...
		// freetds release
		//assertEquals(
		//	cur.getFieldLength(7,3),3);
		//assertEquals(
		//	cur.getFieldLength(7,4),17);
		//assertEquals(
		...
		// so we have to check for a single
		// space here.
		assertEquals(
			cur.getField(0,0)," ");
		assertEquals(
		...
		*/
		...
		// sure that there is one, we'll create
		// a table
		assertTrue(cur.sendQuery(
			"create table testtable "+
			"(col1 int)"));
