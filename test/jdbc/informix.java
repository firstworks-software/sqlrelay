...
class informix extends sqlrtest {
	public static void main(String args[]) throws Exception {
		...
		assertTrue(rsmd.getColumnName(8).
				equalsIgnoreCase("testsmallfloat"));
