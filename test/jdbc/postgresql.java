...
class postgresql extends sqlrtest {
	public static void main(String args[]) throws Exception {
		...
		rs.close();
		System.out.println();
		stmt.executeUpdate("drop function testproc1(int,char,varchar,date)");
		stmt.executeUpdate("drop function testproc2(int,char,varchar,date)");
		stmt.executeUpdate("drop function testproc3(int,char,varchar,date)");
		stmt.executeUpdate("drop function testproc4(int,char,varchar,date)");
