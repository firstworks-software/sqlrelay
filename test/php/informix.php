<html><pre><?php
	...
	sqlrcur_inputBind($cur,"7",2.2,4,2);
	sqlrcur_inputBind($cur,"8",2.2,4,2);
	sqlrcur_inputBind($cur,"9",2.2,4,2);
	...
	sqlrcur_inputBind($cur,"7",3.3,4,2);
	sqlrcur_inputBind($cur,"8",3.3,4,2);
	sqlrcur_inputBind($cur,"9",3.3,4,2);
	...
	sqlrcur_inputBind($cur,"7",4.4,4,2);
	sqlrcur_inputBind($cur,"8",4.4,4,2);
	sqlrcur_inputBind($cur,"9",4.4,4,2);
	...
	sqlrcur_inputBind($cur,"7",6.6,4,2);
	sqlrcur_inputBind($cur,"8",6.6,4,2);
	sqlrcur_inputBind($cur,"9",6.6,4,2);
	...
	sqlrcur_inputBind($cur,"7",8.8,4,2);
	sqlrcur_inputBind($cur,"8",8.8,4,2);
	sqlrcur_inputBind($cur,"9",8.8,4,2);
	...
	assertEqStr(sqlrcur_getField($cur,0,5),"1.10");
	assertEqStr(sqlrcur_getField($cur,0,6),"1.10");
	assertEqStr(sqlrcur_getField($cur,0,7),"1.1");
	assertEqStr(sqlrcur_getField($cur,0,8),"1.1");
	...
	assertEqStr(sqlrcur_getField($cur,7,5),"8.80");
	assertEqStr(sqlrcur_getField($cur,7,6),"8.80");
	assertEqStr(sqlrcur_getField($cur,7,7),"8.8");
	assertEqStr(sqlrcur_getField($cur,7,8),"8.8");
	...
	assertEqStr(sqlrcur_getField($cur,0,"testmoney"),"1.10");
	assertEqStr(sqlrcur_getField($cur,0,"testsmallfloat"),"1.1");
	...
	assertEqStr(sqlrcur_getField($cur,7,"testmoney"),"8.80");
	assertEqStr(sqlrcur_getField($cur,7,"testsmallfloat"),"8.8");
