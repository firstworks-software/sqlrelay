<html><pre><?php
	...
	sqlrcur_clearBinds($cur);
	$arraybindvars=array("var1","var2","var3",
					"var4","var5");
	...
	assertEqStrLen(sqlrcur_getField($cur,0,"TESTBLOB"),
			$largebuffer,8192);
	assertTrue(sqlrcur_sendQuery($cur,"drop table testtable"));
	echo("\n");
	...
	assertEqStrLen(sqlrcur_getField($cur,0,0),$buffer,strlen($buffer));
	assertTrue(sqlrcur_sendQuery($cur,"drop table testtable"));
	echo("\n");
