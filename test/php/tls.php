<html><pre><?php
	...
	assertTrue(sqlrcur_executeQuery($cur));
	assertEqual(sqlrcur_getOutputBindString($cur,"var1"),"hello");
	echo("\n");
	...
	assertTrue(sqlrcur_sendQuery($cur,"insert into testtable values (10,'testchar10','testvarchar10','01-JAN-2010','testlong10','testclob10',empty_blob())"));
	assertTrue(sqlrcur_sendQuery($secondcur,"select count(*) from testtable"));
