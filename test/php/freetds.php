<html><pre><?php
	...
	# identify
	echo("IDENTIFY: \n");
	assertEqual(sqlrcon_identify($con),"freetds");
	echo("\n");
	...
	/*assertEqual(sqlrcur_getColumnLength($cur,5),3);
	assertEqual(sqlrcur_getColumnLength($cur,"testdecimal"),3);
	assertEqual(sqlrcur_getColumnLength($cur,6),3);
	assertEqual(sqlrcur_getColumnLength($cur,"testnumeric"),3);*/
	...
	//assertEqual(sqlrcur_getLongest($cur,3),3);
	//assertEqual(sqlrcur_getLongest($cur,"testreal"),3);
	//assertEqual(sqlrcur_getLongest($cur,4),17);
	//assertEqual(sqlrcur_getLongest($cur,"testfloat"),17);
	...
	//assertEqual(sqlrcur_getLongest($cur,9),26);
	//assertEqual(sqlrcur_getLongest($cur,"testdatetime"),26);
	//assertEqual(sqlrcur_getLongest($cur,10),26);
	//assertEqual(sqlrcur_getLongest($cur,"testsmalldatetime"),26);
	...
	//assertEqual(sqlrcur_getField($cur,0,9),"Jan  1 2001 01:00:00:000AM");
	//assertEqual(sqlrcur_getField($cur,0,10),"Jan  1 2001 01:00:00:000AM");
	...
	//assertEqual(sqlrcur_getField($cur,7,9),"Jan  1 2008 08:00:00:000AM");
	//assertEqual(sqlrcur_getField($cur,7,10),"Jan  1 2008 08:00:00:000AM");
	...
	//assertEqual(sqlrcur_getFieldLength($cur,0,3),3);
	...
	//assertEqual(sqlrcur_getFieldLength($cur,0,9),26);
	//assertEqual(sqlrcur_getFieldLength($cur,0,10),26);
	...
	//assertEqual(sqlrcur_getFieldLength($cur,7,3),3);
	//assertEqual(sqlrcur_getFieldLength($cur,7,4),17);
	...
	//assertEqual(sqlrcur_getFieldLength($cur,7,9),26);
	//assertEqual(sqlrcur_getFieldLength($cur,7,10),26);
	...
	//assertEqual(sqlrcur_getField($cur,0,"testdatetime"),"Jan  1 2001 01:00:00:000AM");
	//assertEqual(sqlrcur_getField($cur,0,"testsmalldatetime"),"Jan  1 2001 01:00:00:000AM");
	...
	//assertEqual(sqlrcur_getField($cur,7,"testdatetime"),"Jan  1 2008 08:00:00:000AM");
	//assertEqual(sqlrcur_getField($cur,7,"testsmalldatetime"),"Jan  1 2008 08:00:00:000AM");
	...
	//assertEqual(sqlrcur_getFieldLength($cur,0,"testdatetime"),26);
	//assertEqual(sqlrcur_getFieldLength($cur,0,"testsmalldatetime"),26);
	...
	//assertEqual(sqlrcur_getFieldLength($cur,7,"testfloat"),17);
	...
	//assertEqual(sqlrcur_getFieldLength($cur,7,"testdatetime"),26);
	//assertEqual(sqlrcur_getFieldLength($cur,7,"testsmalldatetime"),26);
