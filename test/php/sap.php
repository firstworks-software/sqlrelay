...
include("./asserts.php");
	...
	sqlrcur_inputBind($cur,"7",4.4,2,1);
	...
	sqlrcur_inputBind($cur,"var4",7.7,2,1);
	sqlrcur_inputBind($cur,"var5",7.7,2,1);
	sqlrcur_inputBind($cur,"var6",7.7,2,1);
	sqlrcur_inputBind($cur,"var7",7.7,2,1);
	...
	assertEqInt(sqlrcur_getLongest($cur,3),18);
	assertEqInt(sqlrcur_getLongest($cur,"testreal"),18);
	assertEqInt(sqlrcur_getLongest($cur,4),18);
	assertEqInt(sqlrcur_getLongest($cur,"testfloat"),18);
	...
	#assertEqStr(sqlrcur_getField($cur,0,3),"1.1");
	...
	#assertEqStr(sqlrcur_getField($cur,7,3),"8.8");
	#assertEqStr(sqlrcur_getField($cur,7,4),"8.8");
	assertEqStr(sqlrcur_getField($cur,7,5),"8.8");
	assertEqStr(sqlrcur_getField($cur,7,6),"8.8");
	...
	assertEqInt(sqlrcur_getFieldLength($cur,0,3),18);
	assertEqInt(sqlrcur_getFieldLength($cur,0,4),18);
	...
	assertEqInt(sqlrcur_getFieldLength($cur,7,3),18);
	assertEqInt(sqlrcur_getFieldLength($cur,7,4),18);
	...
	assertEqStr(sqlrcur_getField($cur,0,"testnumeric"),"1.1");
	...
	assertEqStr(sqlrcur_getField($cur,7,"testdecimal"),"8.8");
	assertEqStr(sqlrcur_getField($cur,7,"testnumeric"),"8.8");
