...
int main(int argc, char **argv) {
	...
	assertEqInt(sqlrcur_getColumnLengthByIndex(cur,14),16);
	assertEqInt(sqlrcur_getColumnLengthByName(cur,"testdate"),16);
	assertEqInt(sqlrcur_getColumnLengthByIndex(cur,15),16);
	assertEqInt(sqlrcur_getColumnLengthByName(cur,"testtime"),16);
	assertEqInt(sqlrcur_getColumnLengthByIndex(cur,16),16);
	assertEqInt(sqlrcur_getColumnLengthByName(cur,"testdatetime2"),16);
	printf("\n");
	...
	assertEqInt(sqlrcur_getLongestByName(cur,"testdatetime2"),26);
	printf("\n");
	...
	assertEqInt(sqlrcur_getFieldLengthByName(cur,0,"testdatetime2"),26);
	printf("\n");
	...
	assertEqInt(sqlrcur_getFieldLengthByName(cur,7,"testdatetime2"),26);
	printf("\n");
