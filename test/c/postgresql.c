...
int main(int argc, char **argv) {
	...
	// identify
	printf("IDENTIFY: \n");
	assertEqStr(sqlrcon_identify(con),
					"postgresql");
	printf("\n");
	...
	sqlrcur_prepareQuery(cur,
		...
		"	$10)");
	assertEqInt(
		sqlrcur_countBindVariables(cur),10);
	...
	sqlrcur_inputBindString(cur,"6",
					"testvarchar5");
	sqlrcur_inputBindString(cur,"7","01/01/2005");
	sqlrcur_inputBindString(cur,"8","05:00:00");
	sqlrcur_inputBindClob(cur,"9",
					"testtext5",9);
	sqlrcur_inputBindBlob(cur,"10",
					"testbytea5",10);
	...
	assertEqInt(
		...
		4);
	assertEqInt(
		sqlrcur_getColumnLengthByIndex(cur,7),
		8);
	assertEqInt(
		sqlrcur_getColumnLengthByName(cur,
					"testtime"),
		8);
	assertEqInt(
		sqlrcur_getColumnLengthByIndex(cur,8),
		8);
	assertEqInt(
		sqlrcur_getColumnLengthByName(cur,
				"testtimestamp"),
		8);
	assertEqInt(
		sqlrcur_getColumnLengthByIndex(cur,9),
		0);
	assertEqInt(
		sqlrcur_getColumnLengthByName(cur,
					"testtext"),
		0);
	assertEqInt(
		sqlrcur_getColumnLengthByIndex(cur,10),
		0);
	assertEqInt(
		sqlrcur_getColumnLengthByName(cur,
					"testbytea"),
	...
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testint"),1);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,1),3);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testfloat"),3);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,2),3);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testreal"),3);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,3),1);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
				"testsmallint"),1);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,4),40);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testchar"),40);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,5),12);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
				"testvarchar"),12);
	assertEqInt(
	...
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testtime"),8);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,9),9);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testtext"),9);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,10),10);
	assertEqInt(
		sqlrcur_getLongestByName(cur,
					"testbytea"),10);
	printf("\n");
	...
	assertEqStr(
		...
		"1.1");
	assertEqStr(
		sqlrcur_getFieldByIndex(cur,0,3),"1");
	assertEqStr(
	...
	assertEqStr(
		...
		"8.8");
	assertEqStr(
		sqlrcur_getFieldByIndex(cur,7,3),"8");
	assertEqStr(
	...
	assertEqInt(
		...
		10);
	assertEqInt(
		sqlrcur_getFieldLengthByIndex(cur,0,7),
		8);
	assertEqInt(
		sqlrcur_getFieldLengthByIndex(cur,0,9),
		9);
	assertEqInt(
		sqlrcur_getFieldLengthByIndex(cur,0,10),
		10);
	printf("\n");
	assertEqInt(
	...
	assertEqInt(
		...
		10);
	assertEqInt(
		sqlrcur_getFieldLengthByIndex(cur,7,7),
		8);
	assertEqInt(
		sqlrcur_getFieldLengthByIndex(cur,7,9),
		9);
	assertEqInt(
		sqlrcur_getFieldLengthByIndex(cur,7,10),
		10);
	printf("\n");
	...
	assertTrue(sqlrcur_executeQuery(cur));
	assertEqStr(
		sqlrcur_getFieldByIndex(cur,0,0),"3");
	assertTrue(sqlrcur_sendQuery(cur,
		"drop function testfunc(int)"));
	printf("\n");
	...
	assertTrue(sqlrcur_getTypeInfoList(cur,
						"integer"));
	assertEqStr(
		sqlrcur_getColumnName(cur,0),
		"type_name");
	...
	assertTrue(sqlrcur_sendQuery(cur,
		...
		"	testtext text, "
		"	testbytea bytea)"));
	assertTrue(sqlrcur_getColumnList(cur,
					"testtable",
					NULL));
	assertEqStr(
		sqlrcur_getColumnName(cur,0),
	...
	assertTrue(sqlrcur_sendQuery(cur,
		...
		"	col1 int primary key, "
		"	col2 int)"));
	assertTrue(sqlrcur_getPrimaryKeysList(cur,
					"testtable",
					NULL));
	assertEqStr(
	...
	assertTrue(sqlrcur_sendQuery(cur,
		...
		"	col1 int primary key, "
		"	col2 int)"));
	assertTrue(sqlrcur_getKeyAndIndexList(cur,
					"testtable",
					NULL));
	assertEqStr(
		sqlrcur_getColumnName(cur,0),"table");
