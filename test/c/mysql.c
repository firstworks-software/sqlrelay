...
int main(int argc, char **argv) {
	...
	sqlrcur_inputBindString(
		cur,"10","05:00:00");
	sqlrcur_inputBindDate(cur,"11",
		2005,1,1,5,0,0,0,NULL,0);
	sqlrcur_inputBindString(
		cur,"12","2005");
	sqlrcur_inputBindString(
		cur,"13","char5");
	...
	assertEqStr(
		...
		"testblob");
	assertEqStr(
		sqlrcur_getColumnName(cur,19),
		"testtinyblob");
	assertEqStr(
		sqlrcur_getColumnName(cur,20),
		"testmediumblob");
	assertEqStr(
		sqlrcur_getColumnName(cur,21),
		"testlongblob");
	assertEqStr(
		sqlrcur_getColumnName(cur,22),
		"testtimestamp");
	...
	fieldlens=sqlrcur_getRowLengths(
		cur,0);
	...
	// has made.
	secondcon=sqlrcon_alloc("sqlrelay",
