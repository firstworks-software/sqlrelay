...
int main(int argc, char **argv) {
	...
	// column count
	printf("COLUMN COUNT: \n");
	assertEqInt(sqlrcur_colCount(cur),19);
	printf("\n");
	...
	assertEqStr(sqlrcur_getColumnName(cur,13),"testtext");
	assertEqStr(sqlrcur_getColumnName(cur,14),"testvarchar");
	...
	assertEqStr(sqlrcur_getColumnName(cur,18),"testtimestamp");
	...
	assertEqStr(sqlrcur_getColumnTypeByIndex(cur,13),"BLOB");
	assertEqStr(sqlrcur_getColumnTypeByIndex(cur,14),"VARSTRING");
	...
	assertEqStr(sqlrcur_getColumnTypeByIndex(cur,18),"TIMESTAMP");
	...
	assertEqStr(sqlrcur_getColumnTypeByName(cur,"testmediumint"),"MEDIUMINT");
	...
	assertEqStr(sqlrcur_getColumnTypeByName(cur,"testmediumtext"),"MEDIUMBLOB");
	...
	assertEqInt(sqlrcur_getColumnLengthByIndex(cur,13),65535);
	//assertEqInt(sqlrcur_getColumnLengthByIndex(cur,14),41);
	...
	assertEqInt(sqlrcur_getColumnLengthByIndex(cur,18),4);
	...
	assertEqInt(sqlrcur_getColumnLengthByName(cur,"testmediumtext"),16777215);
	assertEqInt(sqlrcur_getColumnLengthByName(cur,"testlongtext"),2147483647);
	...
	assertEqInt(sqlrcur_getLongestByIndex(cur,13),5);
	assertEqInt(sqlrcur_getLongestByIndex(cur,14),8);
	...
	if (majorversion==3) {
		assertEqInt(sqlrcur_getLongestByIndex(cur,18),14);
	} else {
		assertEqInt(sqlrcur_getLongestByIndex(cur,18),19);
	}
	...
	assertEqStr(sqlrcur_getFieldByIndex(cur,0,7),"1.1");
	...
	assertEqStr(sqlrcur_getFieldByIndex(cur,0,13),"text1");
	assertEqStr(sqlrcur_getFieldByIndex(cur,0,14),"varchar1");
	...
	//assertEqStr(sqlrcur_getFieldByIndex(cur,7,5),"8.1");
	assertEqStr(sqlrcur_getFieldByIndex(cur,7,6),"8.1");
	assertEqStr(sqlrcur_getFieldByIndex(cur,7,7),"8.1");
	...
	assertEqStr(sqlrcur_getFieldByIndex(cur,7,13),"text8");
	assertEqStr(sqlrcur_getFieldByIndex(cur,7,14),"varchar8");
	...
	assertEqInt(sqlrcur_getFieldLengthByIndex(cur,0,13),5);
	assertEqInt(sqlrcur_getFieldLengthByIndex(cur,0,14),8);
	...
	assertEqInt(sqlrcur_getFieldLengthByIndex(cur,7,13),5);
	assertEqInt(sqlrcur_getFieldLengthByIndex(cur,7,14),8);
	...
	assertEqStr(sqlrcur_getFieldByName(cur,0,"testdatetime"),"2001-01-01 01:00:00");
	...
	assertEqStr(sqlrcur_getFieldByName(cur,0,"testmediumtext"),"mediumtext1");
	...
	//assertEqStr(sqlrcur_getFieldByName(cur,7,"testfloat"),"8.1");
	assertEqStr(sqlrcur_getFieldByName(cur,7,"testreal"),"8.1");
	assertEqStr(sqlrcur_getFieldByName(cur,7,"testdecimal"),"8.1");
	assertEqStr(sqlrcur_getFieldByName(cur,7,"testdate"),"2008-01-01");
	assertEqStr(sqlrcur_getFieldByName(cur,7,"testtime"),"08:00:00");
	assertEqStr(sqlrcur_getFieldByName(cur,7,"testdatetime"),"2008-01-01 08:00:00");
	...
	assertEqStr(sqlrcur_getFieldByName(cur,7,"testmediumtext"),"mediumtext8");
	...
	assertEqStr(fields[13],"text1");
	assertEqStr(fields[14],"varchar1");
	...
	assertEqInt(fieldlens[13],5);
	assertEqInt(fieldlens[14],8);
