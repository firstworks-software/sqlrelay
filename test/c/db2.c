...
int main(int argc, char **argv) {
	...
	sqlrcur_prepareQuery(cur,
		...
		"	?)");
	assertEqInt(
		sqlrcur_countBindVariables(cur),12);
	...
	sqlrcur_inputBindString(cur,
				"8","testvarchar2");
	sqlrcur_inputBindDate(cur,"9",
		2002,1,1,-1,-1,-1,-1,NULL,0);
	sqlrcur_inputBindDate(cur,"10",
	...
	sqlrcur_inputBindDouble(cur,"4",4.4,4,2);
	sqlrcur_inputBindDouble(cur,"5",4.4,4,2);
	sqlrcur_inputBindDouble(cur,"6",4.4,4,2);
	sqlrcur_inputBindString(cur,
				"7","testchar4");
	sqlrcur_inputBindString(cur,
				"8","testvarchar4");
	...
	sqlrcur_inputBindDouble(cur,"4",6.6,4,2);
	sqlrcur_inputBindDouble(cur,"5",6.6,4,2);
	sqlrcur_inputBindDouble(cur,"6",6.6,4,2);
	sqlrcur_inputBindString(cur,
				"7","testchar6");
	sqlrcur_inputBindString(cur,
				"8","testvarchar6");
	...
	sqlrcur_inputBindDouble(cur,"4",8.8,4,2);
	sqlrcur_inputBindDouble(cur,"5",8.8,4,2);
	sqlrcur_inputBindDouble(cur,"6",8.8,4,2);
	sqlrcur_inputBindString(cur,
				"7","testchar8");
	sqlrcur_inputBindString(cur,
				"8","testvarchar8");
	...
	assertEqInt(
		...
		1);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,2),1);
	assertEqInt(
		sqlrcur_getLongestByName(
			cur,"TESTBIGINT"),
		1);
	...
	assertEqInt(
		...
		4);
	//assertEqInt(
	//	sqlrcur_getLongestByIndex(cur,4),3);
	//assertEqInt(
	//	sqlrcur_getLongestByName(
	//		cur,"TESTREAL"),
	//	3);
	//assertEqInt(
	//	sqlrcur_getLongestByIndex(cur,5),3);
	//assertEqInt(
	//	sqlrcur_getLongestByName(
	//		cur,"TESTDOUBLE"),
	//	3);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,6),40);
	assertEqInt(
		sqlrcur_getLongestByName(
			cur,"TESTCHAR"),
		40);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,7),12);
	assertEqInt(
		sqlrcur_getLongestByName(
			cur,"TESTVARCHAR"),
		12);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,8),10);
	assertEqInt(
		sqlrcur_getLongestByName(
			cur,"TESTDATE"),
		10);
	assertEqInt(
		sqlrcur_getLongestByIndex(cur,9),8);
	assertEqInt(
		sqlrcur_getLongestByName(
			cur,"TESTTIME"),
		8);
	...
	assertTrue(sqlrcur_executeQuery(cur));
	clobvar=
		sqlrcur_getOutputBindClob(cur,"1");
	clobvarlength=
		sqlrcur_getOutputBindLength(cur,"1");
	blobvar=
		sqlrcur_getOutputBindBlob(cur,"2");
	blobvarlength=
		sqlrcur_getOutputBindLength(cur,"2");
	...
	assertEqInt(
		...
		LARGE_BUFFER_LENGTH);
	assertEqStr(
		sqlrcur_getOutputBindClob(cur,"2"),
		largebuffer);
	assertTrue(sqlrcur_sendQuery(cur,
		"drop procedure testproc"));
	assertTrue(sqlrcon_commit(con));
	...
	assertEqStr(
		...
		"hello");
	assertEqStr(
		sqlrcur_getOutputBindClob(cur,"9"),
		"clob");
	assertEqStr(
	...
	assertTrue(sqlrcur_sendQuery(cur,
		...
		"	col2 int)"));
	assertTrue(sqlrcon_commit(con));
	assertTrue(sqlrcur_getPrimaryKeysList(
			cur,"testtable",NULL));
	assertEqStr(
		sqlrcur_getColumnName(cur,0),
		"table");
	...
	assertTrue(sqlrcur_sendQuery(cur,
		...
		"	col2 int)"));
	assertTrue(sqlrcon_commit(con));
	assertTrue(sqlrcur_getKeyAndIndexList(
			cur,"testtable",NULL));
	assertEqStr(
		sqlrcur_getColumnName(cur,0),
		"table");
