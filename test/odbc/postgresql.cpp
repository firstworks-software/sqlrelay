...
int main(int argc, char **argv) {
	...
	*dot='\0';
	...
	assertTrueStmt(stmt,floatfield>1.09 && floatfield<1.11);
	...
	assertTrueStmt(stmt,floatfield>2.19 && floatfield<2.21);
	...
	assertTrueStmt(stmt,floatfield>3.29 && floatfield<3.31);
	...
	assertTrueStmt(stmt,floatfield>4.39 && floatfield<4.41);
	...
	assertSuccessStmt(stmt,erg);
	assertTrueStmt(stmt,gfloatfield>1.09 && gfloatfield<1.11);
