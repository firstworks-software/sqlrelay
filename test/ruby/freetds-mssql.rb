...
# instantiation
con=SQLRConnection.new("sqlrelay",9032,"/tmp/freetds-mssql.socket",
...
assertEqual(cur.getColumnLength(14),16)
assertEqual(cur.getColumnLength("testdate"),16)
assertEqual(cur.getColumnLength(15),16)
assertEqual(cur.getColumnLength("testtime"),16)
assertEqual(cur.getColumnLength(16),16)
assertEqual(cur.getColumnLength("testdatetime2"),16)
print "\n"
...
assertEqual(cur.getLongest("testdatetime2"),26)
print "\n"
...
assertEqual(cur.getField(0,"testdatetime2"),"Jan  1 2001 01:01:01:000PM")
print "\n"
...
assertEqual(cur.getField(7,"testdatetime2"),"Jan  1 2001 01:01:01:000PM")
print "\n"
...
assertEqual(cur.getFieldLength(0,"testdatetime2"),26)
print "\n"
...
assertEqual(cur.getFieldLength(7,"testdatetime2"),26)
print "\n"
...
assertEqual(filename,"cachefile1-freetds-mssql")
cur.cacheOff()
...
secondcon=SQLRConnection.new("sqlrelay",9032,"/tmp/freetds-mssql.socket",
					"testuser","testpassword",0,1)
