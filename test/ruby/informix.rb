...
assertEqual(cur.getColumnType(6),"DECIMAL")
assertEqual(cur.getColumnType("testmoney"),"DECIMAL")
...
#assertEqual(cur.getColumnType(10),"NCHAR")
#assertEqual(cur.getColumnType("testnchar"),"NCHAR")
...
#assertEqual(cur.getColumnType(12),"NVARCHAR")
#assertEqual(cur.getColumnType("testnvarchar"),"NVARCHAR")
...
assertEqual(cur.getColumnType(13),"VARCHAR")
assertEqual(cur.getColumnType("testlvarchar"),"VARCHAR")
...
#assertEqual(cur.getColumnLength(17),2157483647)
#assertEqual(cur.getColumnLength("testbyte"),2157483647)
print "\n"
...
assertEqual(cur.getField(0,5),"1.10")
assertEqual(cur.getField(0,6),"1.10")
assertEqual(cur.getField(0,7),"1.1")
assertEqual(cur.getField(0,8),"1.1")
...
assertEqual(cur.getField(7,5),"8.80")
assertEqual(cur.getField(7,6),"8.80")
assertEqual(cur.getField(7,7),"8.8")
assertEqual(cur.getField(7,8),"8.8")
...
assertEqual(cur.getField(0,"testmoney"),"1.10")
assertEqual(cur.getField(0,"testsmallfloat"),"1.1")
...
assertEqual(cur.getField(7,"testmoney"),"8.80")
assertEqual(cur.getField(7,"testsmallfloat"),"8.8")
...
assertEqual(fields[5],"1.10")
assertEqual(fields[6],"1.10")
assertEqual(fields[7],"1.1")
assertEqual(fields[8],"1.1")
...
assertTrue(cur.executeQuery())
assertEqual(cur.getOutputBindInteger("4"),1)
assertEqual(cur.getOutputBindDouble("5"),1.1)
...
assertEqual(cur.getField(0,"ordinal_position"),"0")
...
assertEqual(cur.getField(1,"ordinal_position"),"1")
...
assertEqual(cur.getField(2,"ordinal_position"),"2")
...
assertEqual(cur.getField(3,"ordinal_position"),"3")
