...
# instantiation
con=SQLRConnection.new("sqlrelay",9002,"/tmp/mysql.socket",
...
assertEqual(cur.getColumnType(14),"TEXT")
assertEqual(cur.getColumnType(15),"TINYTEXT")
assertEqual(cur.getColumnType(16),"MEDIUMTEXT")
assertEqual(cur.getColumnType(17),"LONGTEXT")
...
assertEqual(cur.getColumnType("testtinytext"),"TINYTEXT")
assertEqual(cur.getColumnType("testmediumtext"),"MEDIUMTEXT")
assertEqual(cur.getColumnType("testlongtext"),"LONGTEXT")
...
if majorversion>3
	...
	secondcon=SQLRConnection.new("sqlrelay",9002,"/tmp/mysql.socket",
						"testuser","testpassword",0,1)
