...
# instantiation
con=SQLRConnection.new("sqlrelay",9007,"/tmp/odbc-mssql.socket",
...
# every create procedure below, so it isn't usable here.  rows 5-7 that
# this section would have inserted by name are inserted by position in
# the REMAINING FIXTURE ROWS section below instead
...
# odbc binds positionally, so there is nothing to bind by name.  row 8
# that this section would have inserted by name is inserted by position
# in the REMAINING FIXTURE ROWS section below instead
...
assertEqual(cols[16],"testdatetime2")
print "\n"
...
assertEqual(cur.getColumnType("testdatetime2"),"TIMESTAMP")
print "\n"
...
assertEqual(cur.getColumnLength(0),10)
...
assertEqual(cur.getColumnLength("testtinyint"),3)
assertEqual(cur.getColumnLength(3),24)
assertEqual(cur.getColumnLength("testreal"),24)
assertEqual(cur.getColumnLength(4),53)
assertEqual(cur.getColumnLength("testfloat"),53)
assertEqual(cur.getColumnLength(5),4)
assertEqual(cur.getColumnLength("testdecimal"),4)
assertEqual(cur.getColumnLength(6),4)
assertEqual(cur.getColumnLength("testnumeric"),4)
assertEqual(cur.getColumnLength(7),19)
assertEqual(cur.getColumnLength("testmoney"),19)
assertEqual(cur.getColumnLength(8),10)
assertEqual(cur.getColumnLength("testsmallmoney"),10)
assertEqual(cur.getColumnLength(9),23)
assertEqual(cur.getColumnLength("testdatetime"),23)
assertEqual(cur.getColumnLength(10),16)
assertEqual(cur.getColumnLength("testsmalldatetime"),16)
...
assertEqual(cur.getColumnLength(15),16)
assertEqual(cur.getColumnLength("testtime"),16)
assertEqual(cur.getColumnLength(16),27)
assertEqual(cur.getColumnLength("testdatetime2"),27)
print "\n"
...
assertEqual(cur.getLongest(9),23)
assertEqual(cur.getLongest("testdatetime"),23)
...
assertEqual(cur.getLongest(15),16)
assertEqual(cur.getLongest("testtime"),16)
assertEqual(cur.getLongest(16),27)
assertEqual(cur.getLongest("testdatetime2"),27)
print "\n"
...
assertEqual(cur.getField(0,9),"2001-01-01 01:00:00.000")
...
assertEqual(cur.getField(0,15),"13:01:01.0000000")
assertEqual(cur.getField(0,16),"2001-01-01 13:01:01.0000000")
print "\n"
...
assertEqual(cur.getField(7,9),"2008-01-01 08:00:00.000")
...
assertEqual(cur.getField(7,14),"2001-01-01")
assertEqual(cur.getField(7,15),"13:01:01.0000000")
assertEqual(cur.getField(7,16),"2001-01-01 13:01:01.0000000")
print "\n"
...
assertEqual(cur.getFieldLength(0,9),23)
...
assertEqual(cur.getFieldLength(0,15),16)
assertEqual(cur.getFieldLength(0,16),27)
print "\n"
...
assertEqual(cur.getFieldLength(7,9),23)
...
assertEqual(cur.getFieldLength(7,15),16)
assertEqual(cur.getFieldLength(7,16),27)
print "\n"
...
assertEqual(cur.getField(0,"testdatetime"),"2001-01-01 01:00:00.000")
assertEqual(cur.getField(0,"testsmalldatetime"),"2001-01-01 01:00:00")
...
assertEqual(cur.getField(0,"testtime"),"13:01:01.0000000")
assertEqual(cur.getField(0,"testdatetime2"),"2001-01-01 13:01:01.0000000")
print "\n"
...
assertEqual(cur.getField(7,"testdatetime"),"2008-01-01 08:00:00.000")
assertEqual(cur.getField(7,"testsmalldatetime"),"2008-01-01 08:00:00")
...
assertEqual(cur.getField(7,"testdate"),"2001-01-01")
assertEqual(cur.getField(7,"testtime"),"13:01:01.0000000")
assertEqual(cur.getField(7,"testdatetime2"),"2001-01-01 13:01:01.0000000")
print "\n"
...
assertEqual(cur.getFieldLength(0,"testdatetime"),23)
...
assertEqual(cur.getFieldLength(0,"testtime"),16)
assertEqual(cur.getFieldLength(0,"testdatetime2"),27)
print "\n"
...
assertEqual(cur.getFieldLength(7,"testdatetime"),23)
...
assertEqual(cur.getFieldLength(7,"testtime"),16)
assertEqual(cur.getFieldLength(7,"testdatetime2"),27)
print "\n"
...
assertEqual(fields[9],"2001-01-01 01:00:00.000")
...
assertEqual(fields[15],"13:01:01.0000000")
assertEqual(fields[16],"2001-01-01 13:01:01.0000000")
print "\n"
...
assertEqual(fieldlens[15],16)
assertEqual(fieldlens[16],27)
print "\n"
...
secondcon=SQLRConnection.new("sqlrelay",9007,"/tmp/odbc-mssql.socket",
					"testuser","testpassword",0,1)
...
# model doesn't end it here the way it does under freetds.  the drop
# below would then sit in that transaction, holding a schema lock that
# the next section's reader blocks on rather than fails on, so put
# autocommit back on first
assertTrue(con.autoCommitOn())
assertTrue(cur.sendQuery("drop table testtable"))
print "\n"
...
# encoder emits
assertEqual(cur.getField(0,0),"")
assertEqual(cur.getFieldLength(0,0),0)
assertEqual(cur.getField(0,1),nil)
assertEqual(cur.getField(0,2),"")
assertEqual(cur.getFieldLength(0,2),0)
...
# maxfieldsize, so this connects to a second instance whose maxfieldsize
# is reduced to 4096, where the truncation is reproducible at a
# practical column length
print "WIDE NCHAR COLUMN: \n"
secondcon=SQLRConnection.new("sqlrelay",9033,
...
assertEqual(secondcur.getFieldLength(0,"testnchar"),4000)
assertEqual(secondcur.getField(0,"testnchar"),widencharbuffer)
...
assertEqual(cur.getOutputBindLength("2"),5)
...
print "FAILED EXECUTE AFTER OUTPUT BIND DATE: \n"
cur.sendQuery("drop procedure testproc")
assertTrue(cur.sendQuery(
	"create procedure testproc "+
	"	@out1 int output, "+
...
# if there were, validateBinds() can't be used for output binds here.
...
cur.sendQuery("drop procedure testproc")
longoutputbindbuffer = "C" * 8000
cur.sendQuery(
	"create procedure testproc "+
	"@bindval varchar(8000) output as "+
...
assertEqual(cur.getField(1,"type_name"),"datetime")
assertEqual(cur.getField(1,"data_type"),"93")
assertEqual(cur.getField(1,"precision"),"23")
assertEqual(cur.getField(1,"local_type_name"),"datetime")
print "\n"
...
assertStartsWith(keyname,"PK__testtabl__")
assertTrue(cur.sendQuery("drop table testtable"))
print "\n"
...
assertEqual(cur.rowCount(),2)
assertTrue(cur.getField(0,"table")=="testtable")
assertEqual(cur.getField(0,"key_name"),"")
assertEqual(cur.getField(0,"cardinality"),"0")
assertEqual(cur.getField(0,"index_type"),"0")
assertTrue(cur.getField(1,"table")=="testtable")
assertEqual(cur.getField(1,"non_unique"),"0")
assertEqual(cur.getField(1,"seq_in_index"),"1")
assertTrue(cur.getField(1,"column_name")=="col1")
assertEqual(cur.getField(1,"collation"),"A")
assertEqual(cur.getField(1,"cardinality"),"0")
assertEqual(cur.getField(1,"index_type"),"1")
# mssql auto-names an unnamed primary key constraint
# PK__<table name, truncated to 8 chars>__<hex>, and the hex is
# generated per creation, so only the prefix is stable
keyname=cur.getField(1,"key_name")
assertStartsWith(keyname,"PK__testtabl__")
assertTrue(cur.sendQuery("drop table testtable"))
print "\n"
