...
assertEqual(cur.getLongest(7),6)
assertEqual(cur.getLongest("testmoney"),6)
assertEqual(cur.getLongest(8),6)
assertEqual(cur.getLongest("testsmallmoney"),6)
...
assertEqual(cur.getField(0,7),"1.0000")
assertEqual(cur.getField(0,8),"1.0000")
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getField(7,7),"8.0000")
assertEqual(cur.getField(7,8),"8.0000")
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getFieldLength(0,7),6)
assertEqual(cur.getFieldLength(0,8),6)
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getFieldLength(7,7),6)
assertEqual(cur.getFieldLength(7,8),6)
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getField(0,"testmoney"),"1.0000")
assertEqual(cur.getField(0,"testsmallmoney"),"1.0000")
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getField(7,"testmoney"),"8.0000")
assertEqual(cur.getField(7,"testsmallmoney"),"8.0000")
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getFieldLength(0,"testmoney"),6)
assertEqual(cur.getFieldLength(0,"testsmallmoney"),6)
# freetds datetime rendering for the fixture tds version
...
assertEqual(cur.getFieldLength(7,"testmoney"),6)
assertEqual(cur.getFieldLength(7,"testsmallmoney"),6)
# freetds datetime rendering for the fixture tds version
...
assertEqual(fields[7],"1.0000")
assertEqual(fields[8],"1.0000")
# freetds datetime rendering for the fixture tds version
...
assertEqual(fieldlens[7],6)
assertEqual(fieldlens[8],6)
# freetds datetime rendering for the fixture tds version
