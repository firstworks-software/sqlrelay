...
assertEqual(cur.getField(0,2),"1.50")
assertEqual(cur.getField(0,3),"1.50")
assertEqual(cur.getField(0,4),"1.5000")
assertEqual(cur.getField(0,5),"1.5000")
...
assertEqual(cur.getField(7,2),"8.50")
assertEqual(cur.getField(7,3),"8.50")
assertEqual(cur.getField(7,4),"8.5000")
assertEqual(cur.getField(7,5),"8.5000")
...
assertEqual(cur.getField(0,"TESTNUMERIC"),"1.50")
assertEqual(cur.getField(0,"TESTFLOAT"),"1.5000")
assertEqual(cur.getField(0,"TESTDOUBLE"),"1.5000")
...
assertEqual(cur.getField(7,"TESTNUMERIC"),"8.50")
assertEqual(cur.getField(7,"TESTFLOAT"),"8.5000")
assertEqual(cur.getField(7,"TESTDOUBLE"),"8.5000")
...
assertEqual(fields[2],"1.50")
assertEqual(fields[3],"1.50")
assertEqual(fields[4],"1.5000")
assertEqual(fields[5],"1.5000")
...
assertTrue(cur.executeQuery())
assertEqual(cur.getField(0,0),"1")
assertEqual(cur.getField(0,1),"1.5000")
